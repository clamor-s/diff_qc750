...
# GPU blur is very low quality and causes layout test failures.
# See nvbug 1023183.
LOCAL_CFLAGS += -DSK_DISABLE_GPU_BLUR=1

# Disable buffer orphaning due to excessive garbage collection overhead.
LOCAL_CFLAGS += -DGR_GL_AGGRESSIVE_BUFFER_ORPHANING=0
