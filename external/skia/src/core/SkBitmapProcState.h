...
void S4444_D32_opaque_repeat_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, SkPMColor[], int count);
void S32_D32_opaque_repeat_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, SkPMColor[], int count);
void S16_D32_opaque_repeat_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, SkPMColor[], int count);
void S32_D16_opaque_repeat_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, uint16_t[], int count);
void S4444_D16_opaque_repeat_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, uint16_t[], int count);
void S16_D16_opaque_repeat_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, uint16_t[], int count);

void S4444_D32_opaque_clamp_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, SkPMColor[], int count);
void S32_D32_opaque_clamp_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, SkPMColor[], int count);
void S16_D32_opaque_clamp_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, SkPMColor[], int count);
void S32_D16_opaque_clamp_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, uint16_t[], int count);
void S4444_D16_opaque_clamp_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, uint16_t[], int count);
void S16_D16_opaque_clamp_transonly_nofilter_shaderproc_DX(const SkBitmapProcState&,
        int x, int y, uint16_t[], int count);
