...
def ImagePropFromGlobalDict(glob_dict, mount_point):
  ...
  elif mount_point == "addon_res":
    copy_prop("fs_type", "fs_type")
    copy_prop("addon_size", "partition_size")
  elif mount_point == "addon":
    copy_prop("fs_type", "fs_type")
    copy_prop("addon_size", "partition_size")
...
def main(argv):
  ...
  mount_point = ""
  if image_filename == "system.img" or image_filename == "system_sig.img":
    mount_point = "system"
  elif image_filename == "userdata.img":
    mount_point = "data"
  elif image_filename == "cache.img":
    mount_point = "cache"
  elif image_filename == "addon_nabi2.img":
    mount_point = "addon_res"
  elif image_filename == "addon.img":
    mount_point = "addon"
  else:
