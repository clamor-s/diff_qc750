...
struct {
    ...
    { "pppd_gprs", AID_RADIO, AID_RADIO },//add by vin for usi_3g_module
     {NULL, 0, 0 }
};
...
void handle_property_set_fd()
{
    ...
    case PROP_MSG_SETPROP:
        ...
        getpeercon(s, &source_ctx);
	 	...
	 	ERROR("msg.name=%s uid=%d, gid=%d\n",msg.name,cr.uid,cr.gid);
...
void start_property_service(void)
{
    ...
    /* Read persistent properties after all default values have been loaded. */
    load_persistent_properties();
#ifdef EXTERNAL_SYSTEM_PROPERTY
	load_properties_from_file(EXTERNAL_SYSTEM_PROPERTY);
#endif
