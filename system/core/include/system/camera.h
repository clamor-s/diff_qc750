...
#define FRAMEWORK_HAS_MACRO_MODE_SUPPORT 1
#define FRAMEWORK_HAS_EXTENDED_CAM_INFO_SUPPORT 1
...
enum {
    CAMERA_MSG_ERROR            = 0x00000001, // notifyCallback
    CAMERA_MSG_SHUTTER          = 0x00000002, // notifyCallback
    CAMERA_MSG_FOCUS            = 0x00000004, // notifyCallback
    CAMERA_MSG_ZOOM             = 0x00000008, // notifyCallback
    CAMERA_MSG_PREVIEW_FRAME    = 0x00000010, // dataCallback
    CAMERA_MSG_VIDEO_FRAME      = 0x00000020, // data_timestamp_callback
    CAMERA_MSG_POSTVIEW_FRAME   = 0x00000040, // dataCallback
    CAMERA_MSG_RAW_IMAGE        = 0x00000080, // dataCallback
    CAMERA_MSG_COMPRESSED_IMAGE = 0x00000100, // dataCallback
    CAMERA_MSG_RAW_IMAGE_NOTIFY = 0x00000200, // dataCallback
    // Preview frame metadata. This can be combined with
    // CAMERA_MSG_PREVIEW_FRAME in dataCallback. For example, the apps can
    // request FRAME and METADATA. Or the apps can request only FRAME or only
    // METADATA.
    CAMERA_MSG_PREVIEW_METADATA = 0x00000400, // dataCallback
    CAMERA_MSG_LOWLIGHT_ENTER   = 0x10000000, // notifyCallback
    CAMERA_MSG_LOWLIGHT_EXIT    = 0x20000000, // notifyCallback
    CAMERA_MSG_MACROMODE_ENTER  = 0x40000000, // notifyCallback
    CAMERA_MSG_MACROMODE_EXIT   = 0x80000000, // notifyCallback

    // Notify on autofocus start and stop. This is useful in continuous
    // autofocus - FOCUS_MODE_CONTINUOUS_VIDEO and FOCUS_MODE_CONTINUOUS_PICTURE.
    CAMERA_MSG_FOCUS_MOVE       = 0x00000800,       // notifyCallback
...
enum {
    ...
    /** This is meant for USB camera support. */
    CAMERA_FACING_UNKNOWN = 2
};

enum {
    CAMERA_STEREO_CAPS_UNDEFINED = 0, /* Unspecified stereoscopic capabilities. */
    CAMERA_STEREO_CAPS_MONO = 1, /* Camera is monoscopic. */
    CAMERA_STEREO_CAPS_STEREO = 2 /* Camera is stereoscopic. */
};

enum {
    CAMERA_CONNECTION_UNDEFINED = 0, /* Unspecified connection type. */
    CAMERA_CONNECTION_INTERNAL = 1, /* Camera is internal (built into the device). */
    CAMERA_CONNECTION_USB = 2 /* Camera is connected via USB. */
};
