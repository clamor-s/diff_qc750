 ...
 *
 * Inputs:
 *   nArgc - The number of arguements passed in the papcArgV array.
 ...
 *   pClean - The integer pointed to by this variable will be set to 1 if the
 *     command line specified "-clean" mode, and will be 0 otherwise.
 *
 * Return Value:
 ...
 *
 * Description:
 * The passed license contains a key which is encrypted using the device
 ...
 *    - - -
 */
static int decryptAndDisplayContent(
   char* pLicensePath,
   char* pContentPath
);
 ...
 *
 * Description:
 * Clean all the keys from the application key store.
 *
 * Inputs:
 *   - - -
 *
