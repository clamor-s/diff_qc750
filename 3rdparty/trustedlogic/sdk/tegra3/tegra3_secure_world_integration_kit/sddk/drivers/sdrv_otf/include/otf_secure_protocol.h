 ...
 *
 * @param (index 0), The key that is programmed in the OTF engine. It must be a 128bits buffer.
 *			 Type must be S_PARAM_TYPE_MEMREF_INPUT.
 *			 Field "memref.pBuffer" must point on the key;
 *			 Field "memref.nSize" must be set to 128bits;
 * @param (index 1), Not used, type must be set to S_PARAM_TYPE_NONE
 * @param (index 2), Not used, type must be set to S_PARAM_TYPE_NONE
 * @param (index 3), Not used, type must be set to S_PARAM_TYPE_NONE
 *
