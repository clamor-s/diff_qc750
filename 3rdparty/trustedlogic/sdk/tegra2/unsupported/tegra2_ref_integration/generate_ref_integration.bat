...
set TF_DRIVERS_DIR=%PRODUCT_ROOT%\tegra2_secure_world_integration_kit\sddk\drivers
...
%PRODUCT_ROOT%\tegra2_secure_world_integration_kit\tools\ix86_win32\tf_postlinker %* ^
   -c system_cfg.ini --output %PRODUCT_ROOT%\unsupported\tegra2_ref_integration\tf_ref_integration.bin ^
   %PRODUCT_ROOT%\tegra2_secure_world_integration_kit\bin\tf_core.bin ^
   %TF_DRV_CRYPTO% ^
   %TF_DRV_L2CC%
...
call %PRODUCT_ROOT%\tegra2_secure_world_integration_kit\tools\ix86_win32\tf_gen_include.bat ^
   %PRODUCT_ROOT%\unsupported\tegra2_ref_integration\tf_ref_integration.bin
   
move %PRODUCT_ROOT%\tegra2_secure_world_integration_kit\tools\ix86_win32\tf_include.h .\tf_include.h
