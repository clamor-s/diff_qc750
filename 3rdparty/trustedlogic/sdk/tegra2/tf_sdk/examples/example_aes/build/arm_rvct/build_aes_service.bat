...
echo -c ..\..\..\src\aes_service.c >> armcc_via.txt
echo --thumb >> armcc_via.txt

echo Compile aes_service.c

armcc --via armcc_via.txt
@if ERRORLEVEL 1 goto build_error

echo Compile the resources
..\..\..\..\..\tools\ix86_win32\tf_resc.exe --output aes_service.manifest.o --target elf --manifest ..\..\..\src\aes_service.manifest.txt

echo Linking the service
echo. > armlink_via.txt
echo --bpabi --fpu=none --pltgot=none --dll -o aes_service.srvx aes_service.manifest.o aes_service.o >> armlink_via.txt
