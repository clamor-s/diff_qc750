...
void execute_remove(char *pUUID)
{
   ...
   sServiceUUID.time_mid              = sValue[0];
   sServiceUUID.time_hi_and_version   = sValue[1];
   sServiceUUID.clock_seq_and_node[0] = sValue[2];
   sServiceUUID.clock_seq_and_node[1] = sValue[3];
   sServiceUUID.clock_seq_and_node[2] = sValue[4];
   sServiceUUID.clock_seq_and_node[3] = sValue[5];
   sServiceUUID.clock_seq_and_node[4] = sValue[6];
   sServiceUUID.clock_seq_and_node[5] = sValue[7];
   sServiceUUID.clock_seq_and_node[6] = sValue[8];
   sServiceUUID.clock_seq_and_node[7] = sValue[9];
