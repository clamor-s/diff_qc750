                              ...
                              bool bUseStiplet)
{
   ...
   {
      fprintf(stderr, "Error opening decryption session.\n");
      free(pBlock);
      return;
   }
...
See header for more information
=========================================================================== */
static int init(bool bUseStiplet)
{
   DRM_SESSION_HANDLE hSession;
   DRM_ERROR nError;
...
/* ===========================================================================
    See header for more information
   =========================================================================== */
static int clean(bool bUseStiplet)
{
   DRM_SESSION_HANDLE hSession;
   DRM_ERROR nError;
...
#endif
{
   ...
   if (parseCmdLine(argc, argv, &pLicensePath, &pContentPath, &nDoInit, &nDoClean, &bUseStiplet)==0)
   {
      print_usage();
      return 1;
   }

   if (drm_initialize() != DRM_SUCCESS)
   {
   ...
   {
      decryptAndDisplayContent(pLicensePath, pContentPath, bUseStiplet);
   }
