...
protected:
	 ...
	 static const VolumeCurvePoint sDefaultVolumeCurveExt[AudioPolicyManagerBase::VOLCNT];	
	 ...
	 static const VolumeCurvePoint sSpeakerMediaVolumeCurveExt[AudioPolicyManagerBase::VOLCNT];
