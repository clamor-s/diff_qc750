    ...
    mA2dpSuspended(false), mHasA2dp(false), mHasUsb(false), mHasRemoteSubmix(false)
{
	...
	ALOGE(" load audio policy configuration file, setting defaults");
    // open all output streams needed to access attached devices
    for (size_t i = 0; i < mHwModules.size(); i++) {
	ALOGE(" load audio policy configuration file, setting defaults,mpClientInterface");
...
const AudioPolicyManagerBase::VolumeCurvePoint
    AudioPolicyManagerBase::sDefaultVolumeCurveExt[AudioPolicyManagerBase::VOLCNT] = {
    {1, -39.5f}, {33, -28.5f}, {66, -17.0f}, {100, 0.0f}
};
...
const AudioPolicyManagerBase::VolumeCurvePoint
    AudioPolicyManagerBase::sSpeakerMediaVolumeCurveExt[AudioPolicyManagerBase::VOLCNT] = {
    {1, -29.0f}, {33, -20.0f}, {66, -11.0f}, {100, 0.0f}
};
...
const AudioPolicyManagerBase::VolumeCurvePoint
    ...
    { // AUDIO_STREAM_MUSIC
        ...
        sSpeakerMediaVolumeCurveExt, // DEVICE_CATEGORY_SPEAKER
