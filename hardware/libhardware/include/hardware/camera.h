...
#define FRAMEWORK_HAS_CUSTOM_PARAMETERS_SUPPORT 1
...
typedef struct camera_device_ops {
    ...
    */
    ...
    /** Retrieve the custom camera parameters.  The buffer returned by the
        camera HAL must be returned back to it with put_parameters, if
        put_parameters is not NULL.
     */
