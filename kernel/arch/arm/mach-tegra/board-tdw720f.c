...
static struct tegra_rt5631_platform_data tegra_audio_pdata = {
...
static void ventana_audio_init(void)
{
	struct board_info board_info;

	tegra_get_board_info(&board_info);

	tegra_audio_pdata.codec_name = "rt5631.4-001a";
	tegra_audio_pdata.codec_dai_name = "RT5631-HIFI";
}
...
static int __init ventana_touch_init_Focaltech(void)
{
	tegra_gpio_enable(TEGRA_GPIO_PZ3);
	...
	i2c_register_board_info(0, ventana_i2c_bus1_FT5X0X_info, 1);
