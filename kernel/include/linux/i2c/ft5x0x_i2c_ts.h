...
#define CFG_MAX_POINT_NUM            5    //max touch points supported
#define CFG_NUMOFKEYS                    0x00//0x4    //number of touch keys
#define LINUX_FT5X0X_TS_XY  0
...
#define SCREEN_MAX_HEIGHT_3D	800
#define SCREEN_MAX_WIDTH_3D		1280
