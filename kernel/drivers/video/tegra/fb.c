...
static int tegra_fb_blank(int blank, struct fb_info *info)
{
	...
	case FB_BLANK_UNBLANK:
		...
		if(machine_is_birch())
			tegra_fb->win->flags= TEGRA_WIN_FLAG_ENABLED | TEGRA_WIN_FLAG_INVERT_H | TEGRA_WIN_FLAG_INVERT_V;
		else
					...
					struct resource *fb_mem)
{
	...
	if(machine_is_birch())
		win->flags = TEGRA_WIN_FLAG_ENABLED | TEGRA_WIN_FLAG_INVERT_H | TEGRA_WIN_FLAG_INVERT_V;
	else
