#ifndef ___YUV_SENSOR_H__HM2057
#define ___YUV_SENSOR_H__HM2057
...
#define SENSOR_WAIT_MS       0xFFFE/* special number to indicate this is wait time require */
#define SENSOR_TABLE_END     0xFFFF /* special number to indicate this is end of table */
...
#define HM2057_IOCTL_SET_YUV_EXPOSURE   _IOW('o', 4, __u8)//add keenhi for yuv exposure
#define HM2057_IOCTL_SET_WHITE_BALANCE  _IOW('o', 5, __u8)
#define HM2057_IOCTL_SET_SCENE_MODE     _IOW('o', 6, __u8)
