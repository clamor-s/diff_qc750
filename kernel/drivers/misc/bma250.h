...
typedef struct {
	bma250regs_t *image;
			   /**< pointer to bma250regs_t structure not mandatory */
	unsigned char mode;/**< save current bma250 operation mode */
	unsigned char chip_id,
			   /**< save bma250's chip id which has to be 0x02 after calling bma250_init() */
	 ml_version,			 /**< holds the bma250 ML_version number */
	 al_version;			 /**< holds the bma250 AL_version number */
	unsigned char dev_addr;
			     /**< initializes bma250's I2C device address 0x38 */
	unsigned char int_mask;
			     /**< stores the current bma250 API generated interrupt mask */
	...
	void (*delay_msec) (bma250_MDELAY_DATA_TYPE);
...
/* EasyCASE ( 938
   bma250_write_reg */
int bma250_write_reg(unsigned char addr, unsigned char *data,
		     unsigned char len);
/* EasyCASE ) */
/* EasyCASE ( 939
   bma250_read_reg */
