...
dhd_attach(osl_t *osh, struct dhd_bus *bus, uint bus_hdrlen)
{
	...
	if (strlen(nvram_path) != 0) {
     ...
     if (usi4334_revision == 1)
         strcpy(nv_path, "/system/etc/nvram_4334r1.txt");
     else
         strcpy(nv_path, "/system/etc/nvram_4334.txt");
...
#if defined(CONFIG_BCMDHD_4334_WIFI_CONTROL_FUNC)
	wl_android_wifictrl_func_del();
#endif /* CONFIG_BCMDHD_4334_WIFI_CONTROL_FUNC */
	wl_android_exit();
...
#endif /* defined(CONFIG_BCMDHD_4334_WIFI_CONTROL_FUNC) */
...
#if defined(CONFIG_DHD_4334_USE_STATIC_BUF)
