...
static struct rt5631_init_reg init_list[] = {
	{RT5631_SPK_OUT_VOL		, 0xc9c9},
	{RT5631_HP_OUT_VOL		, 0xc1c1},
	...
	{RT5631_ADC_CTRL_1		, 0x8080}, //bard 6-15
};
...
static const u16 rt5631_reg[RT5631_VENDOR_ID2 + 1] = {
	[RT5631_SPK_OUT_VOL] = 0x8989,
	[RT5631_HP_OUT_VOL] = 0x8181,
	[RT5631_MONO_AXO_1_2_VOL] = 0xa080,
...
static const struct snd_kcontrol_new rt5631_snd_controls[] = {
	...
	SOC_SINGLE("MIC1_BST1 Capture Switch", RT5631_ADC_REC_MIXER,
			RT5631_M_MIC1_RECMIXL_BIT, 1, 1),
	SOC_SINGLE("MIC2_BST2 Capture Switch", RT5631_ADC_REC_MIXER,
			RT5631_M_MIC2_RECMIXR_BIT, 1, 1),
	SOC_SINGLE("MIC Bias1 Switch", RT5631_PWR_MANAG_ADD2,
			RT5631_PWR_MICBIAS1_VOL_BIT, 1,1),
	SOC_SINGLE("MIC Bias2 Switch", RT5631_PWR_MANAG_ADD2,
			RT5631_PWR_MICBIAS2_VOL_BIT, 1,1),
		...
		struct snd_kcontrol *kcontrol, int event)
{
		...
		switch (event) {
		case SND_SOC_DAPM_PRE_PMD:
			snd_soc_update_bits(codec, RT5631_ADC_CTRL_1,
				RT5631_L_MUTE|RT5631_R_MUTE,
				RT5631_L_MUTE|RT5631_R_MUTE);
			break;
...
static const struct snd_soc_dapm_widget rt5631_dapm_widgets[] = {
	...
	SND_SOC_DAPM_ADC_E("Right ADC", "HIFI Capture",
		...
		adc_event, SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU), //bard 6-15
...
static int rt5631_resume(struct snd_soc_codec *codec)
{
	...
	rt5631_reg_init(codec);
	snd_soc_update_bits(codec, RT5631_PWR_MANAG_ADD1, 0x80e0, 0x80e0);
	if (codec->dapm.suspend_bias_level == SND_SOC_BIAS_ON) {
		rt5631_set_bias_level(codec, SND_SOC_BIAS_PREPARE);
		codec->dapm.bias_level = SND_SOC_BIAS_ON;
		schedule_delayed_work(&codec->dapm.delayed_work, msecs_to_jiffies(100));
	}	
	return 0;
}
#else
