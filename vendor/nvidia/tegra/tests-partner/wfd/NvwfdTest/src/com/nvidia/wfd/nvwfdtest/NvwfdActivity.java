...
final public class NvwfdActivity extends Activity
    ...
    private void SinksFound(NvwfdSinkInfo sink) {
        Log.d(LOGTAG, "Sinks found message arrived " + sink.getSsid());
    ...
    private class NvwfdListener implements Nvwfd.NvwfdListener {
        ...
        public void onDiscoverSinks(NvwfdSinkInfo sink) {
            Log.d(LOGTAG, "Sinks found " + sink.getSsid());
            mSinks.add(sink);
    ...
    private Handler msgHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msg.what) {
                case SINKSFOUND:
                {
                    SinksFound((NvwfdSinkInfo)msg.obj);
                    break;
                }
                case CONNECTDONE:
                {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if(item == 0) {
                    if (mConnectedSink != null  && mSinks.contains(mConnectedSink)) {
                        ...
                        mNvwfd.connect(mConnectedSink, null);
                ...
                // Connect in PIN buttom mode
                    ...
                    mAuthenticationPIN = "true";
                    if (mConnectedSink != null  && mSinks.contains(mConnectedSink)) {
                        // Attempt connection
                        Log.d(LOGTAG, "Attempting connect to " + mConnectedSink.getSsid());
                        mNvwfd.connect(mConnectedSink, mAuthenticationPIN);
                    } else {
                        FatalErrorDialog("Sink not available. Discover sinks again.");
                    }
                }
