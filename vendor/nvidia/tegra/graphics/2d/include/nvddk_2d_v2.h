...
typedef enum
{
    ...
    NvDdk2dBlitParamField_Invalid           = 1 << 20,
 ...
 *
 * Currently, the only blit operations which return supplementary values are
 * those which require padded destination rectangle for internal operation
 * and the final crop is skipped though using blit flag
 * NvDdk2dBlitFlags_ReturnDstCrop.
 *
