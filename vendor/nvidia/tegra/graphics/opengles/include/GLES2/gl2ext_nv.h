...
#define GL_PACK_ROW_LENGTH_NV                GL_PACK_ROW_LENGTH
#define GL_PACK_SKIP_ROWS_NV                 GL_PACK_SKIP_ROWS
#define GL_PACK_SKIP_PIXELS_NV               GL_PACK_SKIP_PIXELS
#define GL_PACK_SKIP_IMAGES_NV               GL_PACK_SKIP_IMAGES
#define GL_PACK_IMAGE_HEIGHT_NV              GL_PACK_IMAGE_HEIGHT
#endif
...
#ifndef GL_NV_map_buffer_range
#define GL_NV_map_buffer_range 1
#define GL_MAP_READ_BIT_NV                  0x0001
#define GL_MAP_WRITE_BIT_NV                 0x0002
#define GL_MAP_INVALIDATE_RANGE_BIT_NV      0x0004
#define GL_MAP_INVALIDATE_BUFFER_BIT_NV     0x0008
#define GL_MAP_FLUSH_EXPLICIT_BIT_NV        0x0010
#define GL_MAP_UNSYNCHRONIZED_BIT_NV        0x0020
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void* GL_APIENTRY glMapBufferRangeNV (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
GL_APICALL void GL_APIENTRY glFlushMappedBufferRangeNV (GLenum target, GLintptr offset, GLsizeiptr length);
GL_APICALL GLboolean GL_APIENTRY glUnmapBufferNV(GLenum target);
#endif
typedef void* (GL_APIENTRYP PFNGLMAPBUFFERRANGENVPROC) (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
typedef void (GL_APIENTRYP PFNGLFLUSHMAPPEDBUFFERRANGENV) (GLenum target, GLintptr offset, GLsizeiptr length);
typedef GLboolean (GL_APIENTRYP PFNGLUNMAPBUFFERNV) (GLenum target);
#endif
...
/* GL_EXT_texture_compression_dxt1 - use GL_EXT_texture_compression_s3tc */

#ifndef GL_EXT_texture_compression_dxt1
#define GL_EXT_texture_compression_dxt1 1
/* GL_COMPRESSED_RGB_S3TC_DXT1_EXT defined in GL_EXT_texture_compression_s3tc already. */
/* GL_COMPRESSED_RGBA_S3TC_DXT1_EXT defined in GL_EXT_texture_compression_s3tc already. */
#endif

/* GL_NV_texture_compression_s3tc - use EXT version */
...
/* GL_NV_texture_compression_latc - use EXT version */
