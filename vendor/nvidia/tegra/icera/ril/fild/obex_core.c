...
obex_ResCode obex_CoreReadPacket(obex_PacketDesc *packet)
{
    ...
    obex_LogValue(OBEX_VERBOSE_DEBUG, OBEX_LOG_CORE_CODE, (uint32)prologue.code);
    obex_LogValue(OBEX_VERBOSE_DEBUG, OBEX_LOG_CORE_PACKET_LENGTH, (uint32)packet_length);
...
{
    uint16 header_length;                        /* for byte_sequence and unicode headers */
    ...
    case OBEX_OBJHDTYPE_BYTE_SEQUENCE:
        ...
        header_length = OBEX_MSB_LSB_TO_UINT16(
                                                  prologue->length_msb,
                                                  prologue->length_lsb);
        obex_LogValue(OBEX_VERBOSE_DEBUG, OBEX_LOG_CORE_HEADER_LENGTH, (uint32)header_length);
        ...
        if (OBEX_OBJHDTYPE_BYTE_SEQUENCE==header_type)
        {
            ...
            obex_LogValue(OBEX_VERBOSE_DEBUG, OBEX_LOG_CORE_HEADER_BYTES, (uint32)header_id);
        }
        else
        {
            ...
            obex_LogValue(OBEX_VERBOSE_DEBUG, OBEX_LOG_CORE_HEADER_UNICODE, (uint32)header_id);
        }
        /* move read pointer forward */
    ...
    case OBEX_OBJHDTYPE_1BYTE:
        ...
        obex_LogValue(OBEX_VERBOSE_DEBUG, OBEX_LOG_CORE_HEADER_1_BYTE, (uint32)header_id);
    ...
    case OBEX_OBJHDTYPE_4BYTES:
        ...
        obex_LogValue(OBEX_VERBOSE_DEBUG, OBEX_LOG_CORE_HEADER_4_BYTES, (uint32)header_id);
        break;
    default:
...
uint16 obex_CoreGetHeaderPrologueLength(obex_ObjHdrType header_type)
{
    ...
    case OBEX_OBJHDTYPE_4BYTES:
        ...
        break;
    default:
        OBEX_FAIL("Unknown OBEX header type");
        ret = 0;
        break;
    }
