...
#ifdef __dxp__
#define OBEX_ASSERT(cond)               DEV_ASSERT(cond)
#define OBEX_ASSERT_EXTRA(cond, n, ...) DEV_ASSERT_EXTRA(cond, n, __VA_ARGS__)
#define OBEX_FAIL(msg)                  DEV_ASSERT(!(msg))
#define OBEX_FAIL_EXTRA(msg, n, ...)    DEV_ASSERT_EXTRA(!(msg), n, __VA_ARGS__)
#else
/* TODO: handle fault when not building for DXP... */
#define OBEX_ASSERT(cond)
#define OBEX_ASSERT_EXTRA(cond, n, ...)
#define OBEX_FAIL(msg)
#define OBEX_FAIL_EXTRA(msg, n, ...)
