...
#define ARCH_PROP_BT3                 {ARCH_ACR_BT3,         ARCH_ID_BT3,         ARCH_ICE_ICE_KEY_SET,   false, false, ARCH_TYPE_APPLI, true,  false, false}

#if defined(ICERA_FEATURE_UNSIGNED_IMEI_FILE)
#define ARCH_PROP_IMEI         {ARCH_ACR_IMEI,     ARCH_ID_IMEI,    ARCH_NO_AUTH,         false, false, ARCH_TYPE_DATA,true, false, false}
#elif defined(ICERA_FEATURE_EXT_AUTH_IMEI_FILE)
#define ARCH_PROP_IMEI         {ARCH_ACR_IMEI,     ARCH_ID_IMEI,    ARCH_EXT_AUTH,         false, false, ARCH_TYPE_DATA,true, false, false}
#else
...
#define ARCH_PROP_CUSTCFG      {ARCH_ACR_CUSTCFG,  ARCH_ID_CUSTCFG, ARCH_NO_AUTH,         false, false, ARCH_TYPE_DATA,true, false, false}
#elif defined(ICERA_FEATURE_EXT_AUTH_CUSTCFG_FILE)
#define ARCH_PROP_CUSTCFG      {ARCH_ACR_CUSTCFG,  ARCH_ID_CUSTCFG, ARCH_EXT_AUTH,         false, false, ARCH_TYPE_DATA,true, false, false}
#else
...
#define ARCH_PROP_ZEROCD       {ARCH_ACR_ZEROCD,      ARCH_ID_ZEROCD,    ARCH_NO_AUTH,          false, true,  ARCH_TYPE_DATA,true, false, true}
#else
...
#define ARCH_PROP_CALIB      {ARCH_ACR_CALIB,    ARCH_ID_CALIB, ARCH_EXT_AUTH,         false, false, ARCH_TYPE_DATA,false, false, false}
#else
...
#define ARCH_PROP_DEVICECFG  {ARCH_ACR_DEVICECFG,  ARCH_ID_DEVICECFG,  ARCH_NO_AUTH,  false, false, ARCH_TYPE_DATA, true, false, false}
#elif defined(ICERA_FEATURE_EXT_AUTH_DEVICECFG_FILE)
#define ARCH_PROP_DEVICECFG  {ARCH_ACR_DEVICECFG,  ARCH_ID_DEVICECFG,  ARCH_EXT_AUTH,  false, false, ARCH_TYPE_DATA, true, false, false}
#else
...
typedef struct tagArchFileProperty
{
    ...
    bool pcid_check;               /** Does the file embed public chip ID ? */
