                                  ...
                                  NvxSurface **ppSurface)
{
    ...
    *ppSurface = NvOsAlloc(sizeof(NvxSurface));
    ...
    if (NvxSurfaceAllocYuv(*ppSurface, pNvxVideoCapture->uDestinationWidth, pNvxVideoCapture->uDestinationHeight, NvMMVideoDecColorFormat_YUV420, NvRmSurfaceLayout_Pitch, &uImageSize, NV_FALSE) != NvSuccess)
    {
        NvOsFree(*ppSurface);
        *ppSurface = NULL;
        return;
...
OMX_ERRORTYPE NvxVideoCaptureAcquireResources(OMX_IN NvxComponent *pComponent)
{
    ...
    pNvxVideoCapture->pCapture =  TVMRCaptureCreate(pNvxVideoCapture->eCaptureFormat,
                                                    ...
                                                    TVMR_MAX_CAPTURE_FIELDS, NV_TRUE);
    ...
    pNvxVideoCapture->uFreeCaptureBuffers = (TVMR_MAX_CAPTURE_FIELDS >> 1);
