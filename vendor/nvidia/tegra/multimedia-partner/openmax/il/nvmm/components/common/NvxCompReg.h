...
#ifdef USE_TVMR_OMX
#define NVX_TVMR_COMPONENTS \
  { "OMX.Nvidia.video.mixer", &NvxVideoMixerInit}, \
  { "OMX.Nvidia.video.sink", &NvxVideoTvmrRendererInit}, \
  { "OMX.Nvidia.video.hdmi.sink", &NvxVideoTvmrRendererHDMIInit}, \
  { "OMX.Nvidia.video.crt.sink", &NvxVideoTvmrRendererCRTInit}, \
  { "OMX.Nvidia.video.lvds.sink", &NvxVideoTvmrRendererLVDSInit}, \
  { "OMX.Nvidia.video.capture", &NvxVideoCaptureInit}, \
  { "OMX.Nvidia.audio.capturer", &NvxAudioCapturerInit}   /* really under ALSA, but TVMR is GNULinux only as well */
#endif
#ifdef __cplusplus
}
#endif /* __cplusplus */
