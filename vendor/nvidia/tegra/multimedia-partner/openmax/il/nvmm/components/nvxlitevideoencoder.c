    ...
    case OMX_IndexParamVideoQuantization:
        {
            ...
            pQuantType->nQpB = 0; //not supporting
        }
        break;
...
static OMX_ERRORTYPE NvxVideoEncoderSetParameter(OMX_IN NvxComponent *pComponent, OMX_IN OMX_INDEXTYPE nIndex, OMX_IN OMX_PTR pComponentParameterStructure)
{
    ...
    case OMX_IndexParamVideoBitrate:
        {
            ...
            switch (pBitrate->eControlRate)
            {
                case OMX_Video_ControlRateVariable:
                    ...
                    pNvxVideoEncoder->eRateCtrlMode = NVX_VIDEO_RateControlMode_VBR2;
                    pNvxVideoEncoder->bFrameSkip = NV_FALSE;
                    break;
                case OMX_Video_ControlRateConstant:
                    pNvxVideoEncoder->nEncTuneFlags |= EncTune_USE_APPDefined_RATE_CONTROL;
                    pNvxVideoEncoder->nEncTuneFlags |= EncTune_USE_APPDefined_FRAME_SKIPPING;
                    pNvxVideoEncoder->eRateCtrlMode = NVX_VIDEO_RateControlMode_CBR;
                    pNvxVideoEncoder->bFrameSkip = NV_FALSE;
                    break;
    ...
    case OMX_IndexParamPortDefinition:
        {
            ...
            if(pNvxVideoEncoder->oType == TYPE_H264)
            {
                ...
                pNvxVideoEncoder->nSurfWidth = ((nActualWidth + 15) & ~15);
                pNvxVideoEncoder->nSurfHeight = ((nActualHeight + 15) & ~15);
            ...
            pNvxVideoEncoder->oBase.oPorts[s_nvx_port_input].nWidth = (pNvxVideoEncoder->nSurfWidth + 15) & ~15;
            pNvxVideoEncoder->oBase.oPorts[s_nvx_port_input].nHeight = (pNvxVideoEncoder->nSurfHeight + 15) & ~15;
    ...
    case NVX_IndexParamStoreMetaDataBuffer:
        {
#if USE_ANDROID_NATIVE_WINDOW
            pComponent->pPorts[s_nvx_port_input].oPortDef.nBufferSize = MAX(sizeof(OMX_BUFFERHEADERTYPE), sizeof(NvNativeHandle)) + 4 + 8; // (buffertype + proprietarydata)
#else
...
static OMX_ERRORTYPE NvxVideoEncoderGetConfig(OMX_IN NvxComponent* pNvComp, OMX_IN OMX_INDEXTYPE nIndex, OMX_INOUT OMX_PTR pComponentConfigStructure)
{
    ...
    switch ( nIndex )
    {
        ...
        case OMX_IndexConfigVideoAVCIntraPeriod:
        {
            ...
            pIntraPeriod->nIDRPeriod = pNvxVideoEncoder->nIFrameInterval;
    ...
    case NVX_IndexConfigVideoEncodeQuantizationRange:
        {
            ...
            pQuantRange->nMinQpI = pNvxVideoEncoder->nMinQpI;
            pQuantRange->nMaxQpI = pNvxVideoEncoder->nMaxQpI;
            pQuantRange->nMinQpP = pNvxVideoEncoder->nMinQpP;
            pQuantRange->nMaxQpP = pNvxVideoEncoder->nMaxQpP;
            pQuantRange->nMinQpB = pNvxVideoEncoder->nMinQpB;
            pQuantRange->nMaxQpB = pNvxVideoEncoder->nMaxQpB;
        }
        break;
...
static OMX_ERRORTYPE NvxVideoEncoderCommonstreamProp(SNvxNvMMLiteTransformData *pBase, SNvxLiteVideoEncoderData *pNvxVideoEncoder, NvU32 UpdateParams)
{
    ...
    oVideoParams.VideoEncResolution.width = (Width + 15) & ~15;
    oVideoParams.VideoEncResolution.height = (Height + 15) & ~15;
    oVideoParams.UpdateParams = UpdateParams;
    oVideoParams.StreamIndex = 0;
    oVideoParams.BitRate     = pNvxVideoEncoder->nBitRate;
    oVideoParams.PeakBitrate     = pNvxVideoEncoder->nPeakBitrate;
...
static OMX_ERRORTYPE NvxVideoEncoderSetNvMMAttributes(SNvxNvMMLiteTransformData *pBase, SNvxLiteVideoEncoderData *pNvxVideoEncoder)
{
    ...
    NvError err = NvSuccess;
    NvOsDebugPrintf("+NvxVideoEncoderSetNvMMAttributes");
    ...
    if (pNvxVideoEncoder->bSliceLevelEncode && (!pNvxVideoEncoder->bBitBasedPacketization))
    {
        pNvxVideoEncoder->bSliceLevelEncode = NV_FALSE;
        NV_DEBUG_PRINTF(("Slice level encoding is not possible with MB based packetization\n"));
    }
    ...
    switch ( pNvxVideoEncoder->oType )
    {
        ...
        case TYPE_MPEG4:
        {
            ...
            oMpeg4Params.VirtualBufferSize = pNvxVideoEncoder->nBitRate;
        ...
        case TYPE_H264:
        {
            ...
            oAvcParams.VirtualBufferSize = ((pNvxVideoEncoder->nBitRate)<<8)/100;
...
static OMX_ERRORTYPE NvxVideoEncoderAcquireResources(OMX_IN NvxComponent *pComponent)
{
    ...
    // Use NvOs memory for output buffers
    pNvxVideoEncoder->oBase.bInSharedMemory = NV_FALSE;
