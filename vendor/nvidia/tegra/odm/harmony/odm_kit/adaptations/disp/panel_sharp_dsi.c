...
{
    NVODM_DISP_FP_TO_FX(1.0f), //turtle red
    NVODM_DISP_FP_TO_FX(1.0f) //pure red
};

static NvU32 s_ColorCalibration_Green[2] =
{
    NVODM_DISP_FP_TO_FX(1.00f), //turtle green
    NVODM_DISP_FP_TO_FX(0.8000f) //pure green
};

static NvU32 s_ColorCalibration_Blue[2] =
{
    NVODM_DISP_FP_TO_FX(1.0f), //turtle blue
    NVODM_DISP_FP_TO_FX(0.5166f) //pure blue
};
...
sharpdsi_panel_init( NvOdmDispDeviceHandle hDevice, NvOdmDispDeviceMode *mode)
{
    ...
    /* Get the init sequence list size */
