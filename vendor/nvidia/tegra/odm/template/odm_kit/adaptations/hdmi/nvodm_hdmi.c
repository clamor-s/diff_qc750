...
/*  This dummy export is here so that the template implementation compiles
 *  and links correctly.  It provides no functionality, and is not used by
 *  any driver */

void NvOdmDispHdmiDummy(void);
