...
static const NvOdmGpioPinInfo s_display[] = {
    ...
    { NVODM_PORT('v'), 4, NvOdmGpioPinActiveState_High },   // LCD_BL_EN
...
static const NvOdmGpioPinInfo s_GpioPinKeyInfo[] = {
    {0xE030, 10, NV_TRUE}, /* VOLDOWN */
    {0xE04B, 10, NV_TRUE}, /* VOLUP */
};

// Gpio based keypad
static const NvOdmGpioPinInfo s_GpioKeyBoard[] = {

    {NVODM_PORT('q'), 2, NvOdmGpioPinActiveState_Low, (void *)&s_GpioPinKeyInfo[0]},
