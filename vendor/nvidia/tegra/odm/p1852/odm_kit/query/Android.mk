...
LOCAL_COMMON_C_INCLUDES += $(TEGRA_TOP)/customers/nvidia-partner/template
LOCAL_COMMON_C_INCLUDES += $(TEGRA_TOP)/customers/nvidia-partner/p1852/odm_kit/adaptations/pmu
else
