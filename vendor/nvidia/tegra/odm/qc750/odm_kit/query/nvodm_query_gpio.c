...
static const NvOdmGpioPinInfo s_LvdsDisplay[] = {
    ...
    { NVODM_PORT('h'), 2, NvOdmGpioPinActiveState_High }, // EN_VDD_BL1
    { NVODM_PORT('h'), 3, NvOdmGpioPinActiveState_High }, // LCD1_BL_EN
    ...
    { NVODM_PORT('z'), 4, NvOdmGpioPinActiveState_High } 
#else
    { NVODM_PORT('n'), 6, NvOdmGpioPinActiveState_High }, // Enable (LVDS_SHTDN_L) (LO:OFF, HI:ON)    
    { NVODM_PORT('v'), 3, NvOdmGpioPinActiveState_High }, // LCD1_BL_EN
    { NVODM_PORT('w'), 1, NvOdmGpioPinActiveState_High }, // EN_VDD_PNL
    { NVODM_PORT('h'), 0, NvOdmGpioPinActiveState_High }, // LCD1_BL_PWM
    { NVODM_PORT('g'), 2, NvOdmGpioPinActiveState_High }, // LCD_MODE0
    { NVODM_PORT('g'), 3, NvOdmGpioPinActiveState_Low },  // LCD_MODE1
    ...
    { NVODM_PORT('h'), 5, NvOdmGpioPinActiveState_High }, // LCD_VGL_EN
    { NVODM_PORT('h'), 4, NvOdmGpioPinActiveState_High },  // LCD_VGH_EN
    { NVODM_PORT('u'), 5, NvOdmGpioPinActiveState_High }, // LCD_5V_EN
    { NVODM_PORT('u'), 3, NvOdmGpioPinActiveState_High }, // LCD1_BL_PWM
    { NVODM_PORT('n'), 3, NvOdmGpioPinActiveState_High },
#endif
};
...
static const NvOdmGpioPinInfo s_GpioPinKeyInfo[] = {
    ...
    {0xE02E, 10, NV_TRUE}, /* VOLUP */
};

// Gpio based keypad
static const NvOdmGpioPinInfo s_GpioKeyBoard[] = {
    {NVODM_PORT('r'), 0, NvOdmGpioPinActiveState_Low, (void *)&s_GpioPinKeyInfo[0]},
    {NVODM_PORT('r'), 1, NvOdmGpioPinActiveState_Low, (void *)&s_GpioPinKeyInfo[1]},
    {NVODM_PORT('r'), 2, NvOdmGpioPinActiveState_Low, (void *)&s_GpioPinKeyInfo[2]},
};
