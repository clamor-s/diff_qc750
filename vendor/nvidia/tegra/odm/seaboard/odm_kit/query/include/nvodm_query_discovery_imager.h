...
#define SENSOR_YUV_SOC2030_GUID     NV_ODM_GUID('s','_','S','C','2','0','3','0')

// for specific focuser
#define DW9714L_GUID                NV_ODM_GUID('f','_','D','W','9','7','1','4')

// for specific flash
#define LM3559_GUID                 NV_ODM_GUID('l','_','L','M','3','5','5','9')
