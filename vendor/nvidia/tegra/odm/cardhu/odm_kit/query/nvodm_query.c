...
static const NvU8
s_NvOdmQueryPlatformSetting[] = {'C','a','r','d','h','u',0};
...
#define SET_BIT_5(n) ((n) << 5)
#define DISABLE_BIT_4(n) ((n) & ~(1 << 4))
...
static const NvOdmPinAttrib pin_config[] = {
    ...
    // SDMMC1 is through SDIO2CFG
    {NvOdmPinRegister_T30_PadCtrl_SDIO1CFG,
             NVODM_QUERY_PIN_T30_PADCTRL_SDIO2CFG(0, 0, 46, 42, 1, 1)},

    // SDMMC3 is through SDIO2CFG
    {NvOdmPinRegister_T30_PadCtrl_SDIO3CFG,
             NVODM_QUERY_PIN_T30_PADCTRL_SDIO2CFG(0, 0, 46, 42, 1, 1)},

    // SDMMC4 is through GMA, GMB, GMC and GMD
    {NvOdmPinRegister_T30_PadCtrl_GMACFG,
         NVODM_QUERY_PIN_T30_PADCTRL_VICFG1(9, 9, 3, 3)},

    {NvOdmPinRegister_T30_PadCtrl_GMBCFG,
         NVODM_QUERY_PIN_T30_PADCTRL_VICFG1(9, 9, 3, 3)},

    {NvOdmPinRegister_T30_PadCtrl_GMCCFG,
         NVODM_QUERY_PIN_T30_PADCTRL_VICFG1(9, 9, 3, 3)},

    {NvOdmPinRegister_T30_PadCtrl_GMDCFG,
         NVODM_QUERY_PIN_T30_PADCTRL_VICFG1(9, 9, 3, 3)},
    ...
    //  Disabling IORESET and Setting pulldown to normal for VI_HSYNC
    //  (used by SDMMC1 for power rail CardhuAPGpioRails_VDD_SD_SLOT_3V3)
    {NvOdmPinRegister_T30_PullUpDown_VI_HSYNC,
         SET_PIN_PULLUPDOWN(PULLUPDOWN_NORMAL) | SET_BIT_8(BIT_VAL_0)},

    // PWM pins configuration
    {NvOdmPinRegister_T30_PullUpDown_VI_D6,
        SET_PIN_PULLUPDOWN(PULLUPDOWN_PULLUP) | SET_BIT_8(BIT_VAL_0)},
    {NvOdmPinRegister_T30_PullUpDown_VI_D4,
        SET_PIN_PULLUPDOWN(PULLUPDOWN_PULLUP) | SET_BIT_8(BIT_VAL_0)},
    {NvOdmPinRegister_T30_PullUpDown_GMI_CS2_N,
        SET_PIN_PULLUPDOWN(PULLUPDOWN_PULLUP) | SET_BIT_8(BIT_VAL_0)},
    {NvOdmPinRegister_T30_PullUpDown_GMI_AD10,
        SET_PIN_PULLUPDOWN(PULLUPDOWN_PULLUP) | SET_BIT_8(BIT_VAL_0)},

    // PEX_L1_CLKREQ is connected to VBUS line of USB1. This needs to be
    // pulled down by default.
    {NvOdmPinRegister_T30_PullUpDown_PEX_L1_CLKREQ_N,
            DISABLE_BIT_4(SET_PIN_PULLUPDOWN(PULLUPDOWN_PULLDOWN) | SET_BIT_5(1))},
};
NvU32
