...
$(call local_python_module, nvcamera_demo.py)
$(call local_python_module, nvcamera_exposure.py)
$(call local_python_module, nvcamera_raw.py)
$(call local_python_module, nvcamera_host_input.py)
$(call local_python_module, nvcamera_capture_image.py)
$(call local_python_module, nvcamera_video.py)
