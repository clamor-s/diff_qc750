...
#include "../nvfs/yaffs2/nvyaffs2filesystem.h"
...
NvError NvFsMgrInit(void)
{
    ...
    // initialize function pointers of yaffs2 file system
    gs_FsDriverInfo[NvFsMgrFileSystemType_Yaffs2].Init = &NvYaffs2FileSystemInit;
    gs_FsDriverInfo[NvFsMgrFileSystemType_Yaffs2].Mount = &NvYaffs2FileSystemMount;
    gs_FsDriverInfo[NvFsMgrFileSystemType_Yaffs2].Deinit = &NvYaffs2FileSystemDeinit;
