...
#define BCT_CUSTOMER_DATA_SIZE 908
#endif
...
static NvError NvBctPrivGetDataAp20(
    NvBctHandle hBct,
    NvBctDataType DataType,
    NvU32 *Size,
    NvU32 *Instance,
    ...
    switch(DataType)
    {
        ...
        case NvBctDataType_HashedPartition_PartId:
        {
            ...
            NvBctHashedPartitionInfoRaw *BctHashedPartitionInfoRaw =
                InternalInfoRaw->InternalOneTimeRaw.BctHashedPartInfoRaw;
            NvOsMemcpy(Data, &(BctHashedPartitionInfoRaw[*Instance].PartitionId[0]), *Size);
        }
        break;
        ...
        case NvBctDataType_HashedPartition_CryptoHash:
        {
            ...
            NvBctHashedPartitionInfoRaw *BctHashedPartitionInfoRaw =
                InternalInfoRaw->InternalOneTimeRaw.BctHashedPartInfoRaw;
            NvOsMemcpy(Data, &(BctHashedPartitionInfoRaw[*Instance].CryptoHash[0]), *Size);
        }
        break;
        case NvBctDataType_InternalInfoOneTimeRaw:
        {
...
static NvError NvBctPrivSetDataAp20(
    NvBctHandle hBct,
    NvBctDataType DataType,
    NvU32 *Size,
    NvU32 *Instance,
    void *Data)
{
    ...
    switch(DataType)
    {
        ...
        case NvBctDataType_HashedPartition_PartId:
        {
            ...
            NvBctHashedPartitionInfoRaw *BctHashedPartitionInfoRaw =
                InternalInfoRaw->InternalOneTimeRaw.BctHashedPartInfoRaw;
            NvOsMemcpy(&(BctHashedPartitionInfoRaw[*Instance].PartitionId[0]), Data, *Size);
        }
        break;
