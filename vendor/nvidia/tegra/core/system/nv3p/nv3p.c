    ...
    case Nv3pCommand_OdmCommand:
    {
        ...
        case Nv3pOdmExtCmd_RunSdDiag:
        {
            *length = (1 * 4) + (2 * 4);
            ...
            WRITE32(tmp, command);
            WRITE32(tmp, a->odmExtCmd);
            WRITE32(tmp, a->odmExtCmdParam.sdDiag.Value);
            WRITE32(tmp, a->odmExtCmdParam.sdDiag.TestType);
            break;
        }
        case Nv3pOdmExtCmd_RunSeDiag:
        {
            *length = (1 * 4) + (1 * 4);
            ...
            WRITE32(tmp, command);
            WRITE32(tmp, a->odmExtCmd);
            WRITE32(tmp, a->odmExtCmdParam.seDiag.Value);
            break;
        }
    ...
    NvU8 *packet )
{
    ...
    case Nv3pCommand_OdmCommand:
    {
        ...
        case Nv3pOdmExtCmd_RunSdDiag:
        {
            READ32(tmp, a->odmExtCmdParam.sdDiag.Value);
            READ32(tmp, a->odmExtCmdParam.sdDiag.TestType);
            break;
        }
        case Nv3pOdmExtCmd_RunSeDiag:
        {
            READ32(tmp, a->odmExtCmdParam.seDiag.Value);
            break;
        }
        case Nv3pOdmExtCmd_RunPwmDiag:
        case Nv3pOdmExtCmd_RunDsiDiag:
