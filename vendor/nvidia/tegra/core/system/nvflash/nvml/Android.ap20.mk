...
_avp_local_c_includes += $(TEGRA_TOP)/core/drivers/nvboot/ap20/include
_avp_local_c_includes += $(TEGRA_TOP)/core/drivers/hwinc/ap20
_avp_local_c_includes += $(TEGRA_TOP)/core/drivers/hwinc
_avp_local_c_includes += $(TEGRA_TOP)/core-private/drivers/hwinc
_avp_local_c_includes += $(TEGRA_TOP)/core/system/nvbct/ap20
_avp_local_c_includes += $(TEGRA_TOP)/core/system/nvflash/nvml
_avp_local_c_includes += $(TEGRA_TOP)/core/system/nvflash/nvml/ap20
...
LOCAL_MODULE := libnvml_common_ap20
...
LOCAL_MODULE := nvflash_miniloader_ap20
...
LOCAL_SRC_FILES :=
LOCAL_SRC_FILES += ap20/ap20ml_utils.c
LOCAL_SRC_FILES += ap20/nvml_aes.c
LOCAL_SRC_FILES += ap20/nvml_hash.c

ifeq ($(filter ap20, $(TARGET_TEGRA_VERSION)),)
LOCAL_CHIP := _ap20
else
LOCAL_CHIP :=
endif
...
LOCAL_STATIC_LIBRARIES += libnvml_common_ap20
...
LOCAL_NVIDIA_LINK_SCRIPT_PATH := $(LOCAL_PATH)/ap20
...
# miniloader generated header
LOCAL_PATH := $(_avp_local_path)

include $(NVIDIA_DEFAULTS)

LOCAL_MODULE := nvflash_miniloader_ap20.h
