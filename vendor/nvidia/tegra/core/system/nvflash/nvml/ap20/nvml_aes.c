...
#include "nvrm_drf.h"
#include "ap20/arvde.h"
#include "ap20/aravp_bsea.h"
 ...
 * Address must be aligned to 4 bytes for AP20 Security Engine
 * The length of this key table shall be subject to whether the
 * key schedule generation is in sw/hw.
 */
    ...
    NvBool updateIVOnly)
{
    ...
    * (ref. bug#493656) in AP20. Therefore, a separate macro has
