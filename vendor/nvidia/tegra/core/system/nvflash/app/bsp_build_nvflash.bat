...
REM Change PREBUILDS_WINDOWS_NVFLASH_DIR to prebuilts-windows-nvflash directory cloned from nv-git-07 server.
set PREBUILDS_WINDOWS_NVFLASH_DIR=Y:\prebuilts-windows-nvflash
...
set DEVENV_COMMAND="C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv.exe"
