/*
 * Copyright 2006 - 2010 NVIDIA Corporation.  All Rights Reserved.
 *
...
void stub_BreakPoint(void) { swiSemi(0x18, 0x20025); }
void stub_DebugString(const char *msg) { swiSemi(0x04, (int) msg); }

void stub_Setup( void ) {}
void stub_Vprintf( const char *format, va_list ap ) {}

NvError stub_Vfprintf( NvOsFileHandle stream, const char *format, va_list ap )
{
    return NvError_NotImplemented;
}
NvError stub_Fopen( const char *path, NvU32 flags, NvOsFileHandle *file )
{
    return NvError_NotImplemented;
}
void stub_Fclose(NvOsFileHandle stream) {}
NvError stub_Fwrite( NvOsFileHandle stream, const void *ptr, size_t size )
{
    return NvError_NotImplemented;
}
NvError stub_Fread(NvOsFileHandle stream, void *ptr, size_t size,
    size_t *bytes)
{
    return NvError_NotImplemented;
}
NvError stub_Fseek( NvOsFileHandle file, NvS64 offset, NvOsSeekEnum whence )
{
    return NvError_NotImplemented;
}
NvError stub_Ftell( NvOsFileHandle file, NvU64 *position )
{
    return NvError_NotImplemented;
}
NvError stub_Fflush( NvOsFileHandle stream )
{
    return NvError_NotImplemented;
}
NvError stub_Fsync( NvOsFileHandle stream )
{
    return NvError_NotImplemented;
}
NvError stub_Fremove( const char *filename )
{
    return NvError_NotImplemented;
}
NvError stub_Flock( NvOsFileHandle stream, NvOsFlockType type )
{
    return NvError_NotImplemented;
}
NvError stub_Ftruncate( NvOsFileHandle stream, NvU64 length )
{
    return NvError_NotImplemented;
}

NvError stub_Opendir( const char *path, NvOsDirHandle *dir )
{
    return NvError_NotImplemented;
}
NvError stub_Readdir( NvOsDirHandle dir, char *name, size_t size )
{
    return NvError_NotImplemented;
}
NvError stub_Mkdir( char *name )
{
    return NvError_NotImplemented;
}
void stub_Closedir(NvOsDirHandle dir) {}
NvError stub_GetConfigU32( const char *name, NvU32 *value )
{
    return NvError_NotImplemented;
}
NvError stub_GetConfigString( const char *name, char *value, NvU32 size )
{
    return NvError_NotImplemented;
}
