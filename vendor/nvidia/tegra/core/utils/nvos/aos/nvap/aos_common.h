...
#define GPIO3_K_PA_BASE     0x6000d208  // Base address for argpio.h registers
...
#define GIC_INTERRUPT_INT_ACK( ) \
    (GIC_PA_BASE + FIC_PROC_IF_INT_ACK_0)

#define GIC_INTERRUPT_INT_EOI( ) \
    (GIC_PA_BASE + FIC_PROC_IF_EOI_0)
