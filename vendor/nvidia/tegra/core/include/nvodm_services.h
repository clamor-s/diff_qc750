...
/// Defines the types of fuses that can be read.
typedef enum
{
    NvOdmServiceFuseType_SKU,
    NvOdmServiceFuseType_PackageInfo,

     NvOdmServiceFuseType_Force32 = 0x7fffffffUL
} NvOdmServiceFuseType;

/**
 * Gets the fuse value.
 *
 * @param FuseType Specifies the fuse to be read.
 * @param Value A pointer to the value of the fuse.
 *
 * @return NV_TRUE if successful, otherwise NV_FALSE.
 */
