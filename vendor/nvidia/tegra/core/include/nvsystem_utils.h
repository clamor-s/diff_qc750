...
NvSysUtilBootloaderWrite( NvU8 *bootloader, NvU32 length, NvU32 part_id,
    NvBlOperatingMode, NvU8 *hash, NvU32 hash_size, NvU32 *padded_length);

NvError
NvSysUtilEncyptedBootloaderWrite( NvU8 *bootloader, NvU32 length, NvU32 part_id,
    NvBlOperatingMode, NvU8 *hash, NvU32 hash_size, NvU32 *padded_length, NvBool IsEncrypted );

NvError
NvSysUtilBootloaderReadVerify( NvU8 *bootloader, NvU32 part_id,
    NvBlOperatingMode OperatingMode,NvU64 size, NvU8 *ExpectedHash, NvU64 StagingBufSize);
