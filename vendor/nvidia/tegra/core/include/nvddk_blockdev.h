 ...
 * NvDdkXxxBlockDevInit() routine. Thereafter, one or more (virtual) instances
 ...
 * resources. When all instances have been closed, call NvDdkBlockDevDeinit()
 ...
 * (except for ::NvDdkBlockDevDeinit). Multiple invocations from multiple
...
typedef struct NvDdkBlockDevRec
{
     ...
     *
     * @pre The device must be initialized using NvDdkXxxBlockDevOpen() before
     * using this method.
     *
     * @param hBlockDev Handle acquired during the NvDdkXxxBlockDevOpen() call.
     ...
     *
     * @pre The device needs to be initialized using NvDdkXxxBlockDevOpen()
     *   before
     * using this method.
     *
     * @param hBlockDev Handle acquired during the NvDdkXxxBlockDevOpen() call.
