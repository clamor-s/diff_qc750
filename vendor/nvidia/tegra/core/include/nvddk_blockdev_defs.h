...
typedef enum
{
     ...
     *
     * @par Inputs:
     * ::NvDdkBlockDevIoctl_ErasePartitionInputArgsRec
     *
     * @par Outputs:
     * None.
     */
     ...
     *
     * @par Inputs:
     * ::NvDdkBlockDevIoctl_ProtectSectorsInputArgRec
     *
     * @par Outputs:
     * None.
     */
 ...
 * a physical block address, using the ::SectorsPerBlock information in
 * the ::NvDdkBlockDevInfo structure, which can be obtained by calling
