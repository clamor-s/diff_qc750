...
// 
// current pin assignments to wakeup events in ap15
// wake_event[0] =   uart1_ri
// wake_event[1] =   gp3_pv[3]
// wake_event[2] =   dvi_d3 
// wake_event[3] =   sdio3_dat1
// wake_event[4] =   hdmi_int
// wake_event[5] =   vgp[6]
// wake_event[6] =   gp3_pu[7]
// wake_event[7] =   gp3_pu[6]
// wake_event[8] =   xm2_mio_rdy
// wake_event[9] =   gp3_ps[2]
// wake_event[10] =  hsmmc_dat[1]
// wake_event[11] =  spi2_cs2
// wake_event[12] =  spi2_cs1
// wake_event[13] =  sdio2_dat1
// wake_event[14] =  gp3_pv[6]
// wake_event[15] =  gp3_pt[7]
...
// Events will be latched from the time when minimum power down timer expires (see scratch register 23) to first nonmasked event being active. Due to 32khz granulity on the control, more than one event can become active before latching is disabled.
// This register has valid content  only after leaving lp0 state
// writing 1 (bitwise) resets status for the event.
...
// THIS register is now used as timer for enabling wakup events
// after entering lp0, wakup events will not be detected until timer expires. Counts in 30.51 us cycles.
