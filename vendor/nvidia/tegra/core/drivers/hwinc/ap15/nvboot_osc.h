 ...
 * the order of enum MUST match the HW definition in OSC_CTRL for the first
 * four
 * Note: This is a violation of the sw convention on enums.
 * HW has no corresponding define at this time
 */
typedef enum
{  
