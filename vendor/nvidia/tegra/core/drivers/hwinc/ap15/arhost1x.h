...
// BIC slave has PCI compatible registers
#define NV_HOST1X_BIC_SLAVE_PCICFG      0
// Not PCI compatible
//  BIC configuration address map
//  ------------------------------
//  0x00        < BIC <= BICCFG_MAX  (if BICCFG_MAX = 0xFF then no DEVCFG registers)
//  BICCFG_MAX  < DEV <= 0xFF
//  ------------------------------
#define NV_HOST1X_BIC_SLAVE_BICCFG_MAX  255
// Max PCICFG address owned by BIC
// setup MMIO-BIC parameters
#define NV_MMIO_HOST1X_RD_NUM_REQ       4
#define NV_MMIO_HOST1X_WR_NUM_REQ       4
