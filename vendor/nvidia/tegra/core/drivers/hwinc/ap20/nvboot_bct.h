 ...
 *         Boot Configuration Table (Tegra)</b>
 *
...
/**
 * @defgroup nvbl_bct_ap20 BCT (Tegra)
...
#include "ap20/nvboot_badblocks.h"
#include "ap20/nvboot_devparams.h"
#include "ap20/nvboot_hash.h"
