...
// --------------------------------------------------------------------------
// 
// This register spec is based on the PL310 TRM, please consult the TRM for
// an explanation of the functionality, this spec simply describes the structure
// and provide enumerated values when appropriate
//
//
// ARM groups registers in blocks also called registers to make things simple
// Each of these groups will be usually starting at a naturally aligned boundary
// The natural boundary is 0x100 for PL310
// We call the grouping register block in this spec file
//
// ==============================================================
// Register Block 0
// ==============================================================
...
// Order of counter is indeed such that counter 1 is at address lower than 0
// for both the counter configuration and the counter value
...
// EVENT_COUNTER registers are writable only when counting is disabled
...
// ==============================================================
// Register Blocks 3, 4, 5 and 6 are empty
// ==============================================================
...
// CACHE_SYNC is only a trigger address, no associated field
// but we need something inside to keep simspec happy AFAIK
...
// ==============================================================
// Register Blocks 10 and 11 are empty
// ==============================================================
...
// ==============================================================
// Register Blocks 13 and 14 are empty
// ==============================================================
...
// Register Block 15
// ==============================================================
// first register in register block 15 is at offset 0x40
...
// Prefecth operates by reading ahead of the line currently accessed.  The prefetch offset
// controls how far ahead to go, in unit of cache line.  The default of 0 is the reference
// and indicates to fetch the next cache line, i.e. adding 32 bytes.  The general rule will
// be to fetch (PREFETCH_OFFSET + 1) * 32 ahead of the current address, if the calculated
// address doesn't cross a 4 kB boundary.  Prefetch offset has no effect if prefetch is not 
// enabled by the corresponding bits in AUXILIARY CONTROL register.
