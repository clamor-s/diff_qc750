...
// Control Register 1
// This register maintains DVC configuration fields.
// There are three modes for DVC operations: disabled, fixed voltage adjust mode and continuous mode.
...
// Continous Mode: In this mode the DVC updates the voltage continously to track the PVT changes.
// PMU_WAIT_CNT will be used to wait for the PMU voltage to stabilize.
...
// Control Register 3
// This register is used to configure DVC parameters, like enabling events and choosing ring oscillator.
// TRIG_PM_SA will be used to tak one sample of performance monitor. This will be used in characterization
// LONG_PATH_EN This will choose a long feedback path or short feedback path for ring oscillator, it will take in to account the RC delay due to long path 
...
// Ring osc adder input Register 1
// This i/p should be all '1' so as to enable oscillations
...
// Ring osc adder input Register 2
// Thsi i/p should have all '0' so as to enable oscillations
...
// Firmware can use this bits to trigger DVC for a voltage change request.
...
// get the I2C Master regsiter spec 
////////////////////////////////////////////////////////////////////////////////////////
//Now master can work in two modes.1.Normal mode(old) 2.Packet mode(new)
//In normal mode the registers that need to be programmed are 1.I2C_CNFG[9:0] 2.I2C_CMD_ADDR0 
//3.I2C_CMD_ADDR1 4.I2C_CMD_DATA1 5.I2C_CMD_DATA2 6.I2C_STATUS
//In packet-mode the registers that need to be programmed are 1.I2C_CNFG[10]  2.I2C_TX_PACKET_FIFO
//3.I2C_RX_PACKET_FIFO 4.PACKET_TRANSFER_STATUS 5.FIFO_CONTROL 6.FIFO_STATUS 7.INTERRUPT_MASK_REGISTER 
//8.INTERRUPT_STATUS_REGISTER
////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////
//
// NOTE:
...
//Imp. Note:Please program the field PACKET_MODE_EN of I2C_CNFG register while working in packet mode.
//The set of registers below describe the interface for packet mode only.The registers present in
//the ari2cm.spec describe the interface for normal  mode.With the packet mode interface
//changes,normal mode registers and the operation are not affected.The transition from
//normal mode to packet mode is suggested because packet mode allows 
...
//  Though a packet can contain 4k bytes,because any number of packets can be pushed into
//  the fifo,there is no limit on the no. of bytes that can be transferred.
//3.The transactions to different slaves can be chained together with repeat start and
//   there is no limit on the no. of slaves it can address.
...
// A packet contains header and payload.Header size is variable and could vary from 2 to 5 words. 
//For i2c it is 3 words.The first two words of the header contains generic information.The third word
//contains i2c transaction specific information.payload contains actual data to be written to the
// slave.In case of read operation,payload is nil,hence the packet contains header only .
//
//
//
//
...
//Typically clk source frequency is fixed at 72Mhz.
