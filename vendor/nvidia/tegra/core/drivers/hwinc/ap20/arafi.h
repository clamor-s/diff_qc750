...
//MSI BAR START
// 
// The following defines were taken from //hw/ap/manuals/dev_nv_proj__pcie2_root_port.ref: 
// #define NV_PROJ__PCIE2_RP_MSI_UPPER_ADDR                              0x00000058 /* RW-4R */
// #define NV_PROJ__PCIE2_RP_MSI_LOW_ADDR                                0x00000054 /* RW-4R */
// 
// After reset, the MSI start address will correspond to the upstream FPCI address region 
// 0x58_5400_0000.  Since these defines are used in the manuals directory, there is no good 
// way to include them in the defs directory.  Therefore, if the above defines change in the 
// manuals directory then the define below should be hand edited to match those defines.
//MSI BAR SIZE
