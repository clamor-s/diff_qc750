...
// No. of chips NAND controller can interface.
#define NDFLASH_CS_MAX  8
// Max DMA length
#define NDFLASH_DMA_MAX_BYTES   65536
// DMA target address pointers should be word (32-bit) aligned.
// Alignment spec below indicates interms of bytes
#define NDFLASH_DMA_PTR_ALIGN   4
// Commnand Q packet maximum length in terms of registers
#define NDFLASH_CMDQ_MAX_PKT_LENGTH     15
//====================================================================
//parity bytes for each of the configuration.
//====================================================================
// --------------------Main Area Reed-Solomon selection ---------------
// Single symbol(9bits) Error correction
#define NDFLASH_PARITY_SZ_RS_T1_256     4
// 4 symbol (9bits each symbol, 4 random locations) 
...
// 6 symbol (9bits each symbol, 6 random locations) 
...
// 8 symbol (9bits each symbol, 8 random locations) 
...
// --------------------Spare Area Hamming selection ---------------
// Note: Reed-Solomon for spare is not supported.
...
// Configuraton of this register determines the flash sequence to be initiated
// by NAND controller.
...
// Colletion of NAND flash RBSY line status and more internal operation status
...
// Interrupt status h/w behavior: 
// All interrupt staus bits are SET respective event occurs and write 1 to clear of nature.
...
// Combination of NAND_COMMAND register determines the sequence of opertions to be carried
// on. ECC selection and strength etc are selectable from this register.
...
// Staging register meant for PIO mode of transfer
// Contents should be written by cpu access to this register for write transfer.
// Contents are readable by cpu access to this register after read transfer.
// 
...
// NAND controller DMA interface is configured with this register.
// Per usage model, for no. of page transfers DMA can be initiated ONCE. Maximum no. of pages
// transferrable directly depends on the maximum DMA length of 64K bytes.
...
// NAND DMA Configuration Register for Spare are
...
// Indicates FIFO status useful for debug. Also each of these FIFO buffer can be flushed
// out to come out abnormal conditions like, controller hang etc.
...
// NAND HW Status Command Register
...
// Flash erase operation for selected [7:0] apertures are discared
...
//
// (1) CORRFAIL_ERR flag is added to NAND_ISR register to indicate that out of total DMA transfers
//     of specified pages there are correctable OR un-correctable errors. Please check the description field below. 
//     If there are no correctable/un-correctable errors this bit will not be SET.
//     
// (2) New register NAND_DEC_RESULT indicates the count of pages resulted in correctable/un-correctable errors.
//
// (3) New register NAND_DEC_STAT_BUF. Reading this register will fetch out an entry from decode status buffer. 
//     Each entry of this buffer relate to page which resulted in either correctable/un-correctable error.
//     Please check the description of this entry described as NAND_DEC_STAT_EXT below. 
//     It is up to s/w how this can be used; hopefully this serves for all purposes. 
//Example:
// If there are 4 pages resulted in correctable error and 2 pages of un-correctable error out of total
// DMA transfer of 64 pages, PAGE_COUNT in NAND_DEC_RESULT will indicate as PAGE_COUNT=6. 
// SW should read these 6 entries reading NAND_DEC_STAT_BUF register by CPU access and process it for further action.
...
// Command queue packet structure
// Just a template for s/w structure, for a specific operation packet may not require 
// all of the register updates.
// CMDQ_CMD bit fields indicate which register update should be expected.
//packet CMDQ_PKT
//     479:448  0   REG13
//     447:416  0   REG12 
//     415:384  0   REG11
