...
// Display Serial Interface (DSI) register definition
//
// Planned for inclusion in SC25.
//
//////////////////////////////////////////////////////////////////////
#define DSI_CLASS_REFCOUNT      4094
// AP20_FINC: Please review this count
...
// Start of Line indicator. Toggles at the start of every line.
...
// Line Type is used to convey the type of video line from the display controller
// to the DSI block. The line type implies the generation of one of the associated
// packet sequences as defined in the DSI packet sequence registers (see below).

// Packet DISPLAY2DSI_LT_PKT
#define DISPLAY2DSI_LT_PKT_SIZE 3

// 0 = Line starting with VS
// 1 = Line starting with VE
// 2 = Blank line starting with HS
// 3 = Active line starting with HS
// 4-7 Reserved
...
// Used to construct packet headers. All packet headers are now 32-bits wide regardless
// of whether they are short or long packets.

// Packet DSI_PACKET_HEADER
#define DSI_PACKET_HEADER_SIZE 32

// Defines the meaning / purpose of the packet.
...
// One of 4 virtual channels on the DSI D-PHY link.
...
// Only for long packets, payload for short packets.
...
// Error Correction Code to protect the header.
...
// Used for validation infrastructure only
...
//---------------------- FIFO DEFINITIONS --------------------------
// we mix cpp defines with simspec defines
//   the simspec defines are exported to the generated .uh files
//   the cpp defines are used locally in the ardsi.spec
...
//width is same as HOST_CLRD_SIZE - define from HOST1X
#define NV_DSI_HOSTIF_WRFIFO_DEPTH      12
// width is same as HOST_CLWR_SIZE - define from HOST1X
...
// Register DSI_DSI_RD_DATA_0  // DSI read return data
...
// Each read to this register will pop 32 bits
// from the 32 bit wide read return data FIFO.
// FIFO has NV_DSI_HOST_DATA_RETURN_FIFO_DEPTH entries.
...
// Register DSI_DSI_WR_DATA_0  // Host FIFO write input.
...
// Each write to this register will puch 32 bits
// into the 32 bit wide Host data FIFO.
// FIFO has NV_DSI_HOST_DATA_FIFO_DEPTH entries
...
// Register DSI_DSI_POWER_CONTROL_0  // Display Power Control
...
#define DSI_DSI_POWER_CONTROL_0_LEG_DSI_ENABLE_DISABLE                  _MK_ENUM_CONST(0)    // // Disable DSI

#define DSI_DSI_POWER_CONTROL_0_LEG_DSI_ENABLE_ENABLE                   _MK_ENUM_CONST(1)    // // Enable DSI



// Register DSI_INT_ENABLE_0  // Interrupt enable register
...
#define DSI_INT_ENABLE_0_CTXSW_INT_ENABLE_DISABLE                       _MK_ENUM_CONST(0)    // // interrupt disabled

#define DSI_INT_ENABLE_0_CTXSW_INT_ENABLE_ENABLE                        _MK_ENUM_CONST(1)    // // interrupt enabled



// Register DSI_INT_STATUS_0  // Interrupt Status register
...
// Register DSI_INT_MASK_0  // Interrupt Mask
...
#define DSI_INT_MASK_0_CTXSW_INT_MASK_MASKED                    _MK_ENUM_CONST(0)    // // interrupt masked

#define DSI_INT_MASK_0_CTXSW_INT_MASK_NOTMASKED                 _MK_ENUM_CONST(1)    // // interrupt not masked



// Register DSI_HOST_DSI_CONTROL_0  // DSI control register when input is from HOST
...
// enable Hardware Error Correction Code (ECC) for Host packets
// Note: when ECC is disabled, Host is responsible
// for generating proper ECC byte for header
...
#define DSI_HOST_DSI_CONTROL_0_ECC_ENABLE_DISABLE                       _MK_ENUM_CONST(0)    // // disable HW generation of ECC (Host must calculate ECC).

#define DSI_HOST_DSI_CONTROL_0_ECC_ENABLE_ENABLE                        _MK_ENUM_CONST(1)    // // enable HW generation of ECC.


// enable Hardware Check Sum (CS) for Host packets
// Note: when CS is disabled, Host is responsible
// for generating proper CRC and adding the 2-byte
// CRC to the end of the packet after the payload.
...
#define DSI_HOST_DSI_CONTROL_0_CS_ENABLE_DISABLE                        _MK_ENUM_CONST(0)    // // disable HW generation of CS (Host must calculate CS).

#define DSI_HOST_DSI_CONTROL_0_CS_ENABLE_ENABLE                 _MK_ENUM_CONST(1)    // // enable HW generation of CS.
...
#define DSI_HOST_DSI_CONTROL_0_PKT_BTA_DISABLE                  _MK_ENUM_CONST(0)    // // Do not generate BTA

#define DSI_HOST_DSI_CONTROL_0_PKT_BTA_ENABLE                   _MK_ENUM_CONST(1)    // // Generate BTA after the next packet is sent.


// Generate BTA immediatly, eg. for Tearing Effect reporting.
// Note: This will generate a BTA and pass control of
// the D-PHY to the remote peripheral without the need
// to send any packet. Once the remote peripheral has responded
// and relinquished control of the bus, this bit will be
// cleared by the HW.
...
#define DSI_HOST_DSI_CONTROL_0_IMM_BTA_DISABLE                  _MK_ENUM_CONST(0)    // // Do not generate BTA

#define DSI_HOST_DSI_CONTROL_0_IMM_BTA_ENABLE                   _MK_ENUM_CONST(1)    // // Generate BTA immediately, without waiting for a packet.


// Host Write FIFO Select
...
#define DSI_HOST_DSI_CONTROL_0_PKT_WR_FIFO_SEL_HOST                     _MK_ENUM_CONST(0)    // // Write data to the small host data fifo only.

#define DSI_HOST_DSI_CONTROL_0_PKT_WR_FIFO_SEL_VIDEO                    _MK_ENUM_CONST(1)    // // Write data to both the host and video line store fifo, in series.
...
#define DSI_HOST_DSI_CONTROL_0_DSI_HIGH_SPEED_TRANS_LOW                 _MK_ENUM_CONST(0)    // // low speed - Note: Unlikely ever to be used.

#define DSI_HOST_DSI_CONTROL_0_DSI_HIGH_SPEED_TRANS_HIGH                        _MK_ENUM_CONST(1)    // // high speed


// Host raw data mode. In this mode. All data is sent exactly as
// written. No attempt to decode packet headers is made. This
// bit will aldo override the function of the ECC and CS ENABLE
// fields. No ECC or CS will be generated. This mode is intended
// as a debug / CYA mode only.
...
#define DSI_HOST_DSI_CONTROL_0_RAW_DATA_DISABLE                 _MK_ENUM_CONST(0)    // // Normal mode.

#define DSI_HOST_DSI_CONTROL_0_RAW_DATA_ENABLE                  _MK_ENUM_CONST(1)    // // Enable raw data transmission.
...
#define DSI_HOST_DSI_CONTROL_0_PERIPH_RESET_DISABLE                     _MK_ENUM_CONST(0)    // // Causes an Escape Mode Command to be sent to reset the

#define DSI_HOST_DSI_CONTROL_0_PERIPH_RESET_ENABLE                      _MK_ENUM_CONST(1)    // // external display device. Also starts the PR_TO counter.
// PR_TO state can be checked with the P_RESET_STATUS field
// in the DSI_TO_TALLY register.
// HW clears this bit upon completion of issuing "Trigger Reset"
// OR called "Reset Entry" command is sent out.
...
#define DSI_HOST_DSI_CONTROL_0_HOST_TX_TRIG_SRC_SOL                     _MK_ENUM_CONST(0)    // // Start of Line signal from the Display Controller.

#define DSI_HOST_DSI_CONTROL_0_HOST_TX_TRIG_SRC_FIFO_LEVEL                      _MK_ENUM_CONST(1)    // // How full the FIFO is. Level determined elsewhere.

#define DSI_HOST_DSI_CONTROL_0_HOST_TX_TRIG_SRC_IMMEDIATE                       _MK_ENUM_CONST(2)    // // Determined by a write to the DSI_HOST_TRIGGER field of the
// DSI_TRIGGER register


// Phy clock divider value for byte clock
...
// Write only bit.
// When written with a 1, causes the Verification CRC generator
// to reset to 0xFFFF_FFFF. If written with 0, it has no effect.
...
//write only bit to clear FIFO underflow/overflow
//flags. If there new underflow/overflow event occurs during the
//same time, current access cant clear the status bits
...
// Register DSI_DSI_CONTROL_0  // General DSI Control register
...
#define DSI_DSI_CONTROL_0_DSI_HOST_ENABLE_DISABLE                       _MK_ENUM_CONST(0)    // // disable

#define DSI_DSI_CONTROL_0_DSI_HOST_ENABLE_ENABLE                        _MK_ENUM_CONST(1)    // // enable
...
#define DSI_DSI_CONTROL_0_DSI_VID_ENABLE_DISABLE                        _MK_ENUM_CONST(0)    // // disable

#define DSI_DSI_CONTROL_0_DSI_VID_ENABLE_ENABLE                 _MK_ENUM_CONST(1)    // // enable
...
#define DSI_DSI_CONTROL_0_DSI_VID_SOURCE_DISPLAY_0                      _MK_ENUM_CONST(0)    // // pixels come from "display"

#define DSI_DSI_CONTROL_0_DSI_VID_SOURCE_DISPLAY_1                      _MK_ENUM_CONST(1)    // // pixels come from "displayb"


// Enable for insertion of DCS commands during Display Controller
// generated packets. When enabled, the DCS commands defined in the
// LT3_DCS_CMD and LT5_DCS_CMD fields of the DSI_DCS_CMDS register
// will be inserted in long packets defined in packet sequence 3 and 5.
...
#define DSI_DSI_CONTROL_0_VID_DCS_ENABLE_DISABLE                        _MK_ENUM_CONST(0)    // // No DCS commands will be inserted.

#define DSI_DSI_CONTROL_0_VID_DCS_ENABLE_ENABLE                 _MK_ENUM_CONST(1)    // // DCS command IDs will be inserted as described above.
...
#define DSI_DSI_CONTROL_0_DSI_NUM_DATA_LANES_ONE                        _MK_ENUM_CONST(0)    // // 1 data lane.

#define DSI_DSI_CONTROL_0_DSI_NUM_DATA_LANES_TWO                        _MK_ENUM_CONST(1)    // // 2 data lanes.

#define DSI_DSI_CONTROL_0_DSI_NUM_DATA_LANES_THREE                      _MK_ENUM_CONST(2)    // // 3 data lanes. (NOTE: Currently, this is illegal)

#define DSI_DSI_CONTROL_0_DSI_NUM_DATA_LANES_FOUR                       _MK_ENUM_CONST(3)    // // 4 data lanes. (NOTE: Currently, this is illegal)
...
#define DSI_DSI_CONTROL_0_VID_TX_TRIG_SRC_SOL                   _MK_ENUM_CONST(0)    // // Start of Line signal from the Display Controller.

#define DSI_DSI_CONTROL_0_VID_TX_TRIG_SRC_FIFO_LEVEL                    _MK_ENUM_CONST(1)    // // How full the FIFO is. Level determined elsewhere.

#define DSI_DSI_CONTROL_0_VID_TX_TRIG_SRC_IMMEDIATE                     _MK_ENUM_CONST(2)    // // Determined by a write to the DSI_VID_TRIGGER field of the
// DSI_TRIGGER register


// Pixel Data format transmitted.
// Note that although the pixel format is specified in the
// packet header ID for RGB data packets, this information is
// ignored by the HW. Only the information used in this register
// is used in the construction of RGB data packets.
...
#define DSI_DSI_CONTROL_0_DSI_DATA_FORMAT_BIT16P                        _MK_ENUM_CONST(0)    // // 16 bpp RGB Packed. 2 bytes used per pixel

#define DSI_DSI_CONTROL_0_DSI_DATA_FORMAT_BIT18NP                       _MK_ENUM_CONST(1)    // // 18 bpp RGB Not-packed. 3 bytes used per pixel

#define DSI_DSI_CONTROL_0_DSI_DATA_FORMAT_BIT18P                        _MK_ENUM_CONST(2)    // // 18 bpp RGB Packed. 2.25 bytes used per pixel

#define DSI_DSI_CONTROL_0_DSI_DATA_FORMAT_BIT24P                        _MK_ENUM_CONST(3)    // // 24 bpp RGB Packed. 3 bytes used per pixel


// Virtual channel ID
// Virtual channel is sent as part of packet header
// and used to distinguish multiple displays.
...
#define DSI_DSI_CONTROL_0_DSI_HS_CLK_CTRL_CONTINUOUS                    _MK_ENUM_CONST(0)    // // HS clock is on all the time.

#define DSI_DSI_CONTROL_0_DSI_HS_CLK_CTRL_TX_ONLY                       _MK_ENUM_CONST(1)    // // HS clock is only active during HS transmissions.


// Control signal to turn off clock moninoring
// when enabled for debug, on every DSI byte clock
// debug signal toggles.
// Also TX CRC computation aid will turn on
...
// Register DSI_DSI_SOL_DELAY_0  // Number of byte-clock counts to wait after reception of
...
// Register DSI_DSI_MAX_THRESHOLD_0  // Maximum threshold registers for DSI related packets.
...
// Start draining fifo once this threshold is met
// This register can be used for DBI mode when line packet
// data exceeds the size of the data fifo.
...
// Register DSI_DSI_TRIGGER_0  // Manual transmission trigger register
...
// A 1 written to this bit will start video transmission.
// when DSI_CONTROL.VID_TX_TRIG_SRC is set to IMMEDIATE
// HW auto clears on operation completion
...
// A 1 written to this bit will start host transmission
// when HOST_DSI_CONTROL.HOST_TX_TRIG_SRC is set to IMMEDIATE
// HW auto clears on operation completion
...
// Register DSI_DSI_TX_CRC_0  // Transmission CRC. This is not to be confused with the
...
// Long Packet CRC appened to the end of long packets.
// This CRC is that result of generting a CRC from all
// transmitted bytes.
// If DSI_HOST_ENABLE == ENABLE, then a CRC is generated from
//   all bytes transmitted from the Host interface in Command Mode.
// If DSI_VID_ENABLE  == ENABLE, then a CRC is generated from
//   all bytes transmitted during a frame of video when in Video Mode.
//   Note that the HW will capture the CRC into a seperate
//   internal register so that it can continue to calculate the CRC
//   for the next frame without having to wait for SW to read the
//   current result.
...
// Register DSI_DSI_STATUS_0  // DSI Status Register
...
#define DSI_DSI_STATUS_0_READ_MASK                      _MK_MASK_CONST(0x31f)
#define DSI_DSI_STATUS_0_WRITE_MASK                     _MK_MASK_CONST(0x0)
// Count of how many data words are left in the Host Read
// Data Return FIFO. Typically, SW knows how much data to
// read from the DSI_RD_DATA register after a Read packet / BTA
// has been sent / requested, since these transactions are
// initiated by SW. However, under error conditions, insufficient
// data may have been read from the FIFO. SW should therefore
// check this field to make sure it is 0 after reading all the
// information it expected to get.
...
// Indicates that Line buffer overflow event happened
...
// Indicates that Line buffer underflow event happened
...
// Reserved address 22 [0x16] // Save some space for the future.
// ************************** INITIALISATION SEQUENCE REGISTERS *******************************
//

// Register DSI_DSI_INIT_SEQ_CONTROL_0  // DSI Initialization Sequence Control
...
#define DSI_DSI_INIT_SEQ_CONTROL_0_READ_MASK                    _MK_MASK_CONST(0x1f01)
#define DSI_DSI_INIT_SEQ_CONTROL_0_WRITE_MASK                   _MK_MASK_CONST(0x1f01)
...
// Frame Initialization Sequence Byte Count
// This parameter specifies the number of
// frame initialization sequence cycles to
// send. If programmed to 0, there is no
// frame initialization cycle generated.
//  Valid programmable values:   0  to 16
//  Invalid programmable values: 17 to 31
#define DSI_DSI_INIT_SEQ_CONTROL_0_DSI_FRAME_INIT_BYTE_COUNT_SHIFT                      _MK_SHIFT_CONST(8)
#define DSI_DSI_INIT_SEQ_CONTROL_0_DSI_FRAME_INIT_BYTE_COUNT_FIELD                      _MK_FIELD_CONST(0x1f, DSI_DSI_INIT_SEQ_CONTROL_0_DSI_FRAME_INIT_BYTE_COUNT_SHIFT)
#define DSI_DSI_INIT_SEQ_CONTROL_0_DSI_FRAME_INIT_BYTE_COUNT_RANGE                      12:8
...
// Register DSI_DSI_INIT_SEQ_DATA_0_0  // DSI Init Sequence Write Data 0
...
// DSI Init Sequence Write Data bits 31-0
...
// Register DSI_DSI_INIT_SEQ_DATA_1_0  // DSI Init Sequence Write Data 1
...
// Register DSI_DSI_INIT_SEQ_DATA_2_0  // DSI Init Sequence Write Data 2
...
// Register DSI_DSI_INIT_SEQ_DATA_3_0  // DSI Init Sequence Write Data 3
...
// Reserved address 31 [0x1f] // Save some space for the future.
// ****************************** PACKET SEQUENCE REGISTERS ***********************************
//
// These registers allow the construction of arbitrary packet sequences associated with various
// video line types as sent from the Display Controller to the DSI block.
//
// The first digit of the pair of digits in each field below is the sequence number and second
// digit denotes the packet number within each sequence.
// For example, field PKT_23_ID, defines the ID for packet 3 in sequence 2
//

// Register DSI_DSI_PKT_SEQ_0_LO_0  // DSI Packet Sequence 0 LO half
...
// For packet sequence 0, forces the
// D-PHY to go to LP mode after the
// last packet of the sequence has
// been transmitted.
...
// NOTE: Line Type 0 is associated with the first line in the frame and should
//       contain a packet sequence that starts with a VS packet.

// Register DSI_DSI_PKT_SEQ_0_HI_0  // DSI Packet Sequence 0 HI half
...
// NOTE: Line Type 1 is associated with the last line of Vertical Sync and should
//       contain a packet sequence that starts with a VE packet.

// Register DSI_DSI_PKT_SEQ_1_LO_0  // DSI Packet Sequence 1 LO half
...
// For packet sequence 1, forces the
// D-PHY to go to LP mode after the
// last packet of the sequence has
// been transmitted.
...
// Register DSI_DSI_PKT_SEQ_1_HI_0  // DSI Packet Sequence 1 HI half
...
// NOTE: Line Type 2 is associated with any vertical blank line except the first one after active
//       and should contain a packet sequence that starts with an HS packet.

// Register DSI_DSI_PKT_SEQ_2_LO_0  // DSI Packet Sequence 2 LO half
...
// For packet sequence 2, forces the
// D-PHY to go to LP mode after the
// last packet of the sequence has
// been transmitted.
...
// Register DSI_DSI_PKT_SEQ_2_HI_0  // DSI Packet Sequence 2 HI half
...
// NOTE: Line Type 3 is associated with any active line except the first one
//       and should contain a packet sequence that starts with an HS packet and
//       includes an RGB data packet.

// Register DSI_DSI_PKT_SEQ_3_LO_0  // DSI Packet Sequence 3 LO half
...
// For packet sequence 3, forces the
// D-PHY to go to LP mode after the
// last packet of the sequence has
// been transmitted.
...
// Register DSI_DSI_PKT_SEQ_3_HI_0  // DSI Packet Sequence 3 HI half
...
// NOTE: Line Type 4 is associated with the first vertical blanking line after the last
//       active line and should contain a packet sequence that starts with an HS packet.
//       Ordinarily, this packet sequence should be identical to sequence 2.

// Register DSI_DSI_PKT_SEQ_4_LO_0  // DSI Packet Sequence 4 LO half
...
// For packet sequence 4, forces the
// D-PHY to go to LP mode after the
// last packet of the sequence has
// been transmitted.
...
// Register DSI_DSI_PKT_SEQ_4_HI_0  // DSI Packet Sequence 4 HI half
...
// NOTE: Line Type 5 is associated with the first active line and should contain
//       a packet sequence that starts with an HS packet and includes an RGB data packet.
//       Ordinarily, this packet sequence should be identical to sequence 3.

// Register DSI_DSI_PKT_SEQ_5_LO_0  // DSI Packet Sequence 4 LO half
...
// Register DSI_DSI_PKT_SEQ_5_HI_0  // DSI Packet Sequence 5 HI half
...
// Reserved address 47 [0x2f] // Save some space for PKT_SEQ_6 and 7.
// ********************* DCS COMMAND AND PACKET LENGTH REGISTERS ***************************
//

// Register DSI_DSI_DCS_CMDS_0  // DCS command IDs used for Line Type 3 and 5.
// These command IDs are inserted at the start
// of the data payload of DCS long packets
// when the Display Controller is being used
// to transmit DCS commands.
...
// Register DSI_DSI_PKT_LEN_0_1_0  // DSI packet lengths 0 and 1
...
// Register DSI_DSI_PKT_LEN_2_3_0  // DSI packet lengths 2 and 3
...
// Register DSI_DSI_PKT_LEN_4_5_0  // DSI packet lengths 4 and 5
...
// Register DSI_DSI_PKT_LEN_6_7_0  // DSI packet lengths 6 and 7
...
// Reserved address 56 [0x38] // Save some space for the future.
// ********************* PHYSICAL INTERFACE TIMING REGISTERS ***************************
//

// Register DSI_DSI_PHY_TIMING_0_0  // DSI D-PHY timing register 0
...
// Register DSI_DSI_PHY_TIMING_1_0  // DSI D-PHY timing register 1
...
// Time to drive HS0 before clock goes to LP1        1
...
// Register DSI_DSI_PHY_TIMING_2_0  // DSI D-PHY timing register 2
...
#define DSI_DSI_PHY_TIMING_2_0_RESET_MASK                       _MK_MASK_CONST(0x300)
...
#define DSI_DSI_PHY_TIMING_2_0_READ_MASK                        _MK_MASK_CONST(0x3ff)
#define DSI_DSI_PHY_TIMING_2_0_WRITE_MASK                       _MK_MASK_CONST(0x3ff)
// LP period when exiting ULPM.
// in units of 512 byte clocks.
...
//  Time to run clock before turning on data lane
#define DSI_DSI_PHY_TIMING_2_0_DSI_TCLKPRE_SHIFT                        _MK_SHIFT_CONST(8)
#define DSI_DSI_PHY_TIMING_2_0_DSI_TCLKPRE_FIELD                        _MK_FIELD_CONST(0x3, DSI_DSI_PHY_TIMING_2_0_DSI_TCLKPRE_SHIFT)
#define DSI_DSI_PHY_TIMING_2_0_DSI_TCLKPRE_RANGE                        9:8
...
#define DSI_DSI_PHY_TIMING_2_0_DSI_TCLKPRE_DEFAULT_MASK                 _MK_MASK_CONST(0x3)
...
// Register DSI_DSI_BTA_TIMING_0  // DSI D-PHY Bus-Turn-Around timing
...
// Reserved address 64 [0x40] // Save some space for the future.
// ***************************** CONTENTION RECOVERY TIMERS *******************************
//
// These registers control the length of time - in units of 512 DSI byte clocks - that
// can elapse before the hardware will decide that a bus contention error has occured.
//
// There are several counters to deal with various forms of error that may occur.
// For details, refer to MIPI DSI Spec. section 7.2.2
//

// Register DSI_DSI_TIMEOUT_0_0  // DSI Time out terminal count register 0.
...
// Register DSI_DSI_TIMEOUT_1_0  // DSI Time out terminal count register 1.
...
// Register DSI_DSI_TO_TALLY_0  // DSI Time out tally register.
// Each time one of the time out counters reaches
// its terminal count, it will increment the
// associated tally register.
...
// Reserved address 71 [0x47] // Save some space for the future.
// ************************** PHYSICAL PAD CONTROL REGISTERS ****************************
//

// Register DSI_PAD_CONTROL_0  // DSI PHY configuration register
//  SW can program this register
...
#define DSI_PAD_CONTROL_0_RESET_MASK                    _MK_MASK_CONST(0x10070000)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_OUTADJ0_FIELD                 _MK_FIELD_CONST(0x7, DSI_PAD_CONTROL_0_DSI_PAD_OUTADJ0_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_OUTADJ0_DEFAULT_MASK                  _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_BANDWD_IN_FIELD                       _MK_FIELD_CONST(0x1, DSI_PAD_CONTROL_0_DSI_PAD_BANDWD_IN_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_BANDWD_IN_DEFAULT_MASK                        _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_OUTADJ1_FIELD                 _MK_FIELD_CONST(0x7, DSI_PAD_CONTROL_0_DSI_PAD_OUTADJ1_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_OUTADJ1_DEFAULT_MASK                  _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_OUTADJCLK_FIELD                       _MK_FIELD_CONST(0x7, DSI_PAD_CONTROL_0_DSI_PAD_OUTADJCLK_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_OUTADJCLK_DEFAULT_MASK                        _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_LPDNADJ_FIELD                 _MK_FIELD_CONST(0x3, DSI_PAD_CONTROL_0_DSI_PAD_LPDNADJ_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_LPDNADJ_DEFAULT_MASK                  _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_LPUPADJ_FIELD                 _MK_FIELD_CONST(0x3, DSI_PAD_CONTROL_0_DSI_PAD_LPUPADJ_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_LPUPADJ_DEFAULT_MASK                  _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_PDIO_FIELD                    _MK_FIELD_CONST(0x3, DSI_PAD_CONTROL_0_DSI_PAD_PDIO_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_PREEMP_EN_FIELD                       _MK_FIELD_CONST(0x1, DSI_PAD_CONTROL_0_DSI_PAD_PREEMP_EN_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_PREEMP_EN_DEFAULT_MASK                        _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_SLEWDNADJ_FIELD                       _MK_FIELD_CONST(0x7, DSI_PAD_CONTROL_0_DSI_PAD_SLEWDNADJ_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_SLEWDNADJ_DEFAULT_MASK                        _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_SLEWUPADJ_FIELD                       _MK_FIELD_CONST(0x7, DSI_PAD_CONTROL_0_DSI_PAD_SLEWUPADJ_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_SLEWUPADJ_DEFAULT_MASK                        _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_REV_CLK_FIELD                 _MK_FIELD_CONST(0x1, DSI_PAD_CONTROL_0_DSI_PAD_REV_CLK_SHIFT)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_REV_CLK_DEFAULT_MASK                  _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_0_DSI_PAD_PULLDN_ENAB_FIELD                     _MK_FIELD_CONST(0x1, DSI_PAD_CONTROL_0_DSI_PAD_PULLDN_ENAB_SHIFT)
...
// Register DSI_PAD_CONTROL_CD_0  // contention detection logic
// enable signals
...
#define DSI_PAD_CONTROL_CD_0_RESET_MASK                         _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_CD_0_DSI_PAD_CD_EN_FIELD                        _MK_FIELD_CONST(0x3, DSI_PAD_CONTROL_CD_0_DSI_PAD_CD_EN_SHIFT)
...
#define DSI_PAD_CONTROL_CD_0_DSI_PAD_CD_EN_DEFAULT_MASK                 _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_CD_0_DSI_PAD_CD_EN_CLK_DEFAULT_MASK                     _MK_MASK_CONST(0x0)
...
#define DSI_PAD_CONTROL_CD_0_DSI_PAD_CDDNADJ_DEFAULT_MASK                       _MK_MASK_CONST(0x0)
...
// Register DSI_PAD_CD_STATUS_0  // Contention detection status
// from MIPI PAD
...
#define DSI_PAD_CD_STATUS_0_DSI_PAD_CDP_FIELD                   _MK_FIELD_CONST(0x3, DSI_PAD_CD_STATUS_0_DSI_PAD_CDP_SHIFT)
...
#define DSI_PAD_CD_STATUS_0_DSI_PAD_CDN_FIELD                   _MK_FIELD_CONST(0x3, DSI_PAD_CD_STATUS_0_DSI_PAD_CDN_SHIFT)
...
// ----- DSI Pad Calibration -----
//
// The calibration of the MIPI DSI pads is actually controlled
// in the CSI (Camera Serial Interface) registers set since the
// DSI and CSI share a common calibration mechanism.
//
// see : /defs/arcsi.spec
//
// The following register does not appear in the DSI registers set
// but the details are given here for reference purposed.
//
// For details and background about why this register is where
// it is, read bug 313029.
//
// Reserve space for the register so that we can add it later ...

// Reserved address 78 [0x4e]
// reg   DSI_MIPI_CAL_CONFIG    incr1   // Calibration settings for DSI mipi pad
//        4:0 rw MIPI_CAL_TERMOSD   i=0 // 2's complement offset for TERMADJ
//       12:8 rw MIPI_CAL_HSPUOSD   i=0 // 2's complement offset for HSPUADJ
//      20:16 rw MIPI_CAL_HSPDOSD   i=0 // 2's complement offset for HSPDADJ
//         30 rw MIPI_CAL_OVERIDED  i=0 // When 0 (normal operation), use the above registers
...
#define DSI2_LAST_REG 0x001e // DSI_DSI_INIT_SEQ_DATA_3_0
#define DSI3_FIRST_REG 0x0023 // DSI_DSI_PKT_SEQ_0_LO_0
#define DSI3_LAST_REG 0x002e // DSI_DSI_PKT_SEQ_5_HI_0
#define DSI4_FIRST_REG 0x0033 // DSI_DSI_DCS_CMDS_0
#define DSI4_LAST_REG 0x0037 // DSI_DSI_PKT_LEN_6_7_0
#define DSI5_FIRST_REG 0x003c // DSI_DSI_PHY_TIMING_0_0
#define DSI5_LAST_REG 0x003f // DSI_DSI_BTA_TIMING_0
#define DSI6_FIRST_REG 0x0044 // DSI_DSI_TIMEOUT_0_0
#define DSI6_LAST_REG 0x0046 // DSI_DSI_TO_TALLY_0
#define DSI7_FIRST_REG 0x004b // DSI_PAD_CONTROL_0
#define DSI7_LAST_REG 0x004d // DSI_PAD_CD_STATUS_0
