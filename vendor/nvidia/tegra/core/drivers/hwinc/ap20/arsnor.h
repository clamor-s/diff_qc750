...
// --------------------------------------------------------------------------
//
// Summary: SNOR Controller
//
// --------------------------------------------------------------------------
// The configuration register is used to set 32/16 bit wide memories, mux/non-mux, 
// burst length, when ready will be asserted, page sizes, modes of operation
// such as burst reads/writes, page reads, async reads/writes, etc.
// In addition, 3 select bits are provided for selecting the 8 chip selects
...
// This status register has bits that provide the the controller status, along with the external
// interrupts from the SNOR devices. The FIFO status is also provided along with the status on the
// count of the words transferred through DMA 
...
// This register contains the timing parameters used for the page access, along with the timing parameters for 
// the widths of ADV pulse, CE hold, etc
// Sync NOR  Timing0 Register
//
...
// This register contains the MIO configuration bits suchas the width of the words, 
// the polarity of the ready along with the three bits to select the 8 different chip selects for MIO
...
// This register contains the timing parameters for the MIO accesses
// MIO Timing - 0 Register
//
...
// Sync NOR DMA Configuration Register
//
...
// Sync NOR CHIP Select MUX Configuration Register
//
