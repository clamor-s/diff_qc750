...
//
// --------------------------------------------------------------------------
// This define is used in chip.config to ifdef protection statements
// that are only for the headers.
// ****************************************************************
// This file is automatically generated by FUSEGEN.  Do NOT modify.
// ****************************************************************
//
// Fuse Control Block (FCB) register definition
//
// Protection levels:
...
//
// Default is private.
// The fuse register description should not be made customer-visible. Setting protected mode.
// Fuse control register
// FUSECTRL_CMD: Commands include IDLE, READ (from fuses) WRITE (to fuses), SENSE_CTRL (which senses ctrl fuses
// FUSECTRL_BURN_LOG, FUSECTRL_SKUSEL: If soft fuse is present, 
// then BURN_LOG and SKUSEL are for the current burn log and skusel value
// FUSECTRL_STATE: Will be one of STATE_RESET, STATE_POST_RESET, STATE_IDLE, STATE_LOAD_ROW0, STATE_LOAD_ROW1
// STATE_READ_SETUP, STATE_READ_STROBE, STATE_SAMPLE_FUSES, STATE_READ_HOLD, STATE_WRITE_SETUP, STATE_WRITE_ADDR_SETUP
// STATE_WRITE_PROGRAM, STATE_WRITE_ADDR_HOLD
// FUSECTRL_AES_ST: If soft fuse is present, it indicates the state of the AES checker
// FUSECTRL_RAMREPAIR_SHIFT_DONE: If 1, ramrepair shift is completed, else ramrepair data is invalid;
// FUSECTRL_FUSE_SENSE_DONE: If 1, all the chip options have been loaded with fuse data. Else fuse data is invalid
...
// Fuse address register - stores read/write address for sw access to fuse macro
...
// Fuse read data register - read data is stored in this register after fuse reads
...
// Fuse write data register - write data is stored in this register for fuse writes
...
// Fusetime_rd1 - stores fuse read setup and hold times
...
// Fusetime_rd2 - stores the sense time for fuse read
...
// Fusetime_pgm1 - stores the write setup and hold times
...
// Fusetime_pgm2 - stores the program time for fuse writes
...
// This register is used to trigger intfc reads by host and can also skip ramrepair shift
...
// Private Key Disable register
// This register can only be 1-written. Once written, the private key becomes invisible (read as all 1s).
...
// Disable Register Programming register
// This register can only be 1-written. Once written, the fuse register programming is disabled.
...
// Software power good register to provide inputs to the level shifter
// outside the fuse block which in turn drives the pwrok of the regulator
...
// This register controls the regulator reference voltage
// Refer fuse macro documentation on libola for the ratios
...
// This register controls the regulator bias current
// Refer fuse macro documentation on libola for the ratios
...
// This registers have a 'nonzero_reg' modifier in chip config. 
// Reads from these locations return the value of whether the chip option was nonzero or zero
...
// Chip Option: production_mode
// NV - Production mode (NV Production)
//   set high until control fuse outputs are valid to disable boot from norflash
//   and write-protect other NVIDIA-controlled fuses
// Reset to high
...
// Chip Option: jtag_secureID_valid
// NV - Enable secure JTAG
//   set high until control fuse outputs are valid to prevent unsecure jtag access
// Reset to high
...
// Chip Option: fa
// NV - Failure analysis (enables obs bus and jtag when blown)
//      can only be blown through secure JTAG
// Write protected by (!(jtag_secure_allowed && jtag_secureID_valid && security_mode))
...
// Chip Option: hdmi_lane0_calib
// NV - HDMI calibration (part 1/4)
// Write protected by production_mode
...
// Chip Option: hdmi_lane1_calib
// NV - HDMI calibration (part 2/4)
// Write protected by production_mode
...
// Chip Option: hdmi_lane2_calib
// NV - HDMI calibration (part 3/4)
// Write protected by production_mode
...
// Chip Option: hdmi_lane3_calib
// NV - HDMI calibration (part 4/4)
// Write protected by production_mode
...
// Chip Option: security_mode
// Customer - Security mode (ODM Production)
//   set high until control fuse outputs are valid to disable fuse programming through the register interface
//   and write-protect other customer-controlled fuses
// Reset to high
// Disabled by fa
...
// Chip Option: private_key0
// Customer - Private/Secret Key (SBK0)
// Write protected by security_mode
// Hidden to high by (fa || private_key_disable_sw)
// Jtag readback hidden to high by (fa || private_key_disable_sw || security_mode)
...
// Chip Option: private_key1
// Customer - Private/Secret Key (SBK1)
// Write protected by security_mode
// Hidden to high by (fa || private_key_disable_sw)
// Jtag readback hidden to high by (fa || private_key_disable_sw || security_mode)
...
// Chip Option: private_key2
// Customer - Private/Secret Key (SBK2)
// Write protected by security_mode
// Hidden to high by (fa || private_key_disable_sw)
// Jtag readback hidden to high by (fa || private_key_disable_sw || security_mode)
...
// Chip Option: private_key3
// Customer - Private/Secret Key (SBK3)
// Write protected by security_mode
// Hidden to high by (fa || private_key_disable_sw)
// Jtag readback hidden to high by (fa || private_key_disable_sw || security_mode)
...
// Chip Option: private_key4
// Customer - Private/Secret Key (DK)
// Write protected by security_mode
// Hidden to high by (fa || private_key_disable_sw)
// Jtag readback hidden to high by (fa || private_key_disable_sw || security_mode)
...
// Chip Option: arm_debug_dis
// Customer - Disable ARM debug capability
// Reset to high
// Write protected by security_mode
// Disabled by fa
...
// Chip Option: boot_device_info
// Customer - Boot device info (read by bootrom code)
// Write protected by security_mode
...
// Chip Option: reserved_sw
// Customer - Reserved bits for SW
// Write protected by security_mode
...
// Chip Option: arm_debug_control
// Customer - Define ARM debug capability when arm_debug_dis is not set
// Write protected by security_mode
...
// Chip Option: reserved_odm0
// Customer - Reserved bits for ODM / SW versioning (ODM0)
...
// Chip Option: reserved_odm1
// Customer - Reserved bits for ODM / SW versioning (ODM1)
...
// Chip Option: reserved_odm2
// Customer - Reserved bits for ODM / SW versioning (ODM2)
...
// Chip Option: reserved_odm3
// Customer - Reserved bits for ODM / SW versioning (ODM3)
...
// Chip Option: reserved_odm4
// Customer - Reserved bits for ODM / SW versioning (ODM4)
...
// Chip Option: reserved_odm5
// Customer - Reserved bits for ODM / SW versioning (ODM5)
...
// Chip Option: reserved_odm6
// Customer - Reserved bits for ODM / SW versioning (ODM6)
...
// Chip Option: reserved_odm7
// Customer - Reserved bits for ODM / SW versioning (ODM7)
...
// Chip Option: nor_info
// NV - NOR flash config
//   bit 0: x16/x32
//   bit 1: muxed mode/non muxed mode
// Write protected by production_mode
...
// Chip Option: kfuse_privkey_ctrl
// NV - KFUSE private key access control
// Write protected by production_mode
...
// Chip Option: package_info
// NV - Package info
//   bit 0: pop/non-pop package
//   bit 1: reserved
// Write protected by production_mode
