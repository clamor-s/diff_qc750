...
/**
 * Returns the interface to be used for AP15 AES engine.
 *
 * @param pAp15AesHw Pointer to the interface
 *
 * @retval None
 */
void
Ap15GetAesHwInterface(
AesHwInterface *pAp15AesHw);

/**
 * Returns the interface to be used for AP20 AES engine.
 *
