...
#define SPI_BUSY_MAX_TIMEOUT_MSEC   15000
#define SPI_BUSY_POLL_STEP_MSEC 10
    while (timeout < SPI_BUSY_MAX_TIMEOUT_MSEC)
    {
        ...
        NvOsSleepMS(SPI_BUSY_POLL_STEP_MSEC);
        timeout += SPI_BUSY_POLL_STEP_MSEC;
    }
#undef  SPI_BUSY_POLL_STEP_MSEC
#undef  SPI_BUSY_MAX_TIMEOUT_MSEC
    return e;
}
