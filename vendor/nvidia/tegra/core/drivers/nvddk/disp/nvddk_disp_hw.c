...
NvDdkDispBuiltin dc_tv2_builtin =
    {
        DcTvo2Enable,
        DcTvo2ListModes,
        DcTvo2SetPowerLevel,
...
NvDdkDispTvoHal dc_tvo2_hal =
    {
        DcTvo2Type,
        DcTvo2Attrs,
        DcTvo2Position,
        DcTvo2MacrovisionSetContext,
        DcTvo2MacrovisionEnable,
        DcTvo2MacrovisionSetCGMSA_20,
        DcTvo2MacrovisionSetCGMSA_21,
    };
...
NvDdkDispHalInit( NvDdkDispCapabilities *caps, NvDdkDispHal *hal )
{
    ...
    if( caps->engine == NvDdkDispEngine_Dc )
    {
        ...
        if( discover( NvOdmIoModule_Tvo ) )
        {
            if( NVDDK_DISP_CAP_IS_SET( caps, NvDdkDispCapBit_Hdtv_Analog ) )
            {
                hal->Tv = &dc_tv2_builtin;
                hal->TvHal = &dc_tvo2_hal;
            }
        }
