 ...
 *
 * @b Description: Implements AP20 USB Host controller private functions
 *
 */
...
void UsbhPrivAp20StoreRegOffsets(NvDdkUsbhHandle pUsbHcdCtxt)
{
...
void UsbhPrivAp20GetPortSpeed(NvDdkUsbhHandle pUsbHcdCtxt)
{
    pUsbHcdCtxt->UsbPortSpeed = (NvDdkUsbPortSpeedType)USB_REG_READ_VAL(PORTSC1, PSPD) +1;
}
