    ...
    NvDdkUsbPhyHandle hUsbPhy)
{
    ...
    {
        {1, 5, 0, NvRmModulePlatform_Silicon, &s_UsbPhyCap[2]}, // AP20, USB1
        {1, 6, 0, NvRmModulePlatform_Silicon, &s_UsbPhyCap[2]}, // AP20, USB2
        {1, 7, 0, NvRmModulePlatform_Silicon, &s_UsbPhyCap[2]}, // AP20, USB3
        {2, 0, 0, NvRmModulePlatform_Silicon, &s_UsbPhyCap[3]}, // T30, USB1
        {2, 1, 0, NvRmModulePlatform_Silicon, &s_UsbPhyCap[3]}, // T30, USB2
        {2, 2, 0, NvRmModulePlatform_Silicon, &s_UsbPhyCap[3]}, // T30, USB3
    };
    ...
    {
        T30UsbPhyOpenHwInterface(hUsbPhy);
    }
    else if (hUsbPhy->Caps.PhyRegInController)
    {
