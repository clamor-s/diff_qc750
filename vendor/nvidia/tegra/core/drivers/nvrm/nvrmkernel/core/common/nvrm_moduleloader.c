...
NvU32 NvRmModuleGetChipId(NvRmDeviceHandle hDevice)
{
    ...
    NvRmModuleCapability caps[] =
        {
            {1, 1, 0, NvRmModulePlatform_Silicon, (void *)&Cap20},
            {1, 0, 0, NvRmModulePlatform_Silicon, (void *)&Cap15},
            {1, 1, 0, NvRmModulePlatform_Silicon, (void *)&Cap16},
            {1, 2, 0, NvRmModulePlatform_Silicon, (void *)&Cap30},
        };
    ...
    Error = NvRmModuleGetCapabilities(hDevice, NvRmModuleID_BseA, caps, 4, (void **)&capabilities);
            ...
            SegmentNode **segmentList)
{
    ...
    Error = NvRmMemAllocTagged(pLoadRegion,
                         Heaps,
                         NumHeaps,
