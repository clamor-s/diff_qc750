...
NvError NvRmPrivT30ChipUniqueId(NvRmDeviceHandle hDevHandle,void* pId)
{
    ...
    // Enable fuse clock
    T30EnableModuleClock(hDevHandle, NvRmModuleID_Fuse, NV_TRUE);
#endif
...
#if NV_USE_FUSE_CLOCK_ENABLE
    // Disable fuse clock
    T30EnableModuleClock(hDevHandle, NvRmModuleID_Fuse, NV_FALSE);
#endif
