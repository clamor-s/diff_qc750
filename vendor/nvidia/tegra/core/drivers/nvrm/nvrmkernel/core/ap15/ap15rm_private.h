...
void NvRmPrivT30GetBondOut( NvRmDeviceHandle hDevice,
                        const NvU32 **pTable, NvU32 *bondOut );
...
/** Basic reset of T30 chip modules */
void NvRmPrivT30BasicReset( NvRmDeviceHandle hDevice );
...
/** This API starts the memory controller error monitoring for T30. */
NvError NvRmPrivT30McErrorMonitorStart( NvRmDeviceHandle hDevice );

/** This API stops the memory controller error monitoring for T30. */
void NvRmPrivT30McErrorMonitorStop( NvRmDeviceHandle hDevice );
...
/** This API sets up the memory controller for T30. */
void NvRmPrivT30SetupMc(NvRmDeviceHandle hRm);
