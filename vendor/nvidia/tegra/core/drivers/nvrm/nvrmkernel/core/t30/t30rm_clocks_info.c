...
const NvRmModuleClockInfo g_T30ModuleClockTable[] =
{
    {   /* Invalid module */
...
NvU32 const g_T30ModuleClockTableSize = NV_ARRAY_SIZE(g_T30ModuleClockTable);
...
static NvBool s_T30PllM0Clocks[NV_ARRAY_SIZE(g_T30ModuleClockTable)] = {0};
static NvBool s_T30PllC0Clocks[NV_ARRAY_SIZE(g_T30ModuleClockTable)] = {0};
static NvBool s_T30PllP0Clocks[NV_ARRAY_SIZE(g_T30ModuleClockTable)] = {0};
static NvBool s_T30PllA0Clocks[NV_ARRAY_SIZE(g_T30ModuleClockTable)] = {0};
static NvBool s_T30PllD0Clocks[NV_ARRAY_SIZE(g_T30ModuleClockTable)] = {0};
static NvBool s_T30PllX0Clocks[NV_ARRAY_SIZE(g_T30ModuleClockTable)] = {0};
    ...
    NvU32* pPllReferencesTableSize)
{
    ...
    for (i = 0; i < s_T30PllReferencesTableSize; i++)
    {
        NvOsMemset(s_T30PllReferencesTable[i].AttachedModules, 0,
                   sizeof(NvBool) * g_T30ModuleClockTableSize);
...
void
NvRmPrivT30PowerGroupTableInit(
