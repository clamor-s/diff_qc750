...
static NvPinmuxPrivMethods* NvRmPrivGetPinmuxMethods(NvRmDeviceHandle hDevice)
{
    ...
    static NvPinmuxPrivMethods s_T30Methods =
    {
        NvRmPrivT30InitTrisateRefCount,
#ifndef SET_KERNEL_PINMUX
        NvRmT30GetPinMuxConfigs,
        NvRmPrivT30SetPinMuxCtl,
        NvRmPrivT30SetPadTristates,
#endif
        NvRmPrivT30FindConfigStart,
        NvRmT30GetPinForGpio,
        NvRmPrivT30SetGpioTristate,
#ifndef SET_KERNEL_PINMUX
        NvRmPrivT30GetModuleInterfaceCaps,
#endif
        NvRmPrivT30EnableExternalClockSource,
        NvRmPrivT30GetExternalClockSourceFreq,
        // FIXME: use following for T30 as of now.
        NvRmAp20GetStraps
    };
