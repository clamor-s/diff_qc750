...
LOCAL_SRC_FILES += core/ap15/ap15rm_surface.c
LOCAL_SRC_FILES += core/ap15/ap15rm_hwmap.c
LOCAL_SRC_FILES += core/ap15/ap15rm_avp_service.c
LOCAL_SRC_FILES += core/common/nvrm_avp_cpu_rpc.c
LOCAL_SRC_FILES += core/common/nvrm_chiplib.c
...
LOCAL_SRC_FILES += null_stubs/nvrm_dma_stub.c
...
LOCAL_SRC_FILES += null_stubs/nvrm_interrupt_stub.c
LOCAL_SRC_FILES += null_stubs/nvrm_keylist_stub.c
LOCAL_SRC_FILES += null_stubs/nvrm_memctrl_stub.c
LOCAL_SRC_FILES += null_stubs/nvrm_module_stub.c
LOCAL_SRC_FILES += null_stubs/nvrm_owr_stub.c
LOCAL_SRC_FILES += null_stubs/nvrm_pcie_stub.c
...
LOCAL_SRC_FILES += core/ap15/ap15rm_gart.c
LOCAL_SRC_FILES += core/ap15/ap15rm_clocks.c
...
LOCAL_SRC_FILES += core/ap15/ap15rm_pinmux.c
...
LOCAL_SRC_FILES += core/ap15/ap15rm_init_common.c
...
LOCAL_SRC_FILES += core/ap20/ap20rm_reloctable.c
LOCAL_SRC_FILES += core/ap20/ap20rm_clocks.c
LOCAL_SRC_FILES += core/ap20/ap20rm_clock_config.c
LOCAL_SRC_FILES += core/ap20/ap20rm_memctrl.c
LOCAL_SRC_FILES += core/ap20/ap20rm_power_dfs.c
LOCAL_SRC_FILES += core/ap20/ap20rm_pinmux_tables.c
LOCAL_SRC_FILES += core/ap20/ap20rm_fuse.c
LOCAL_SRC_FILES += core/ap20/ap20rm_clocks_info.c
LOCAL_SRC_FILES += core/ap20/ap20rm_gart.c
LOCAL_SRC_FILES += io/ap20/ap20rm_i2c.c
LOCAL_SRC_FILES += io/ap20/ap20rm_pcie.c
LOCAL_SRC_FILES += io/ap20/ap20rm_slink_hw_private.c
LOCAL_SRC_FILES += io/ap20/ap20rm_owr.c
...
LOCAL_SRC_FILES += core/t30/t30rm_reloctable.c
LOCAL_SRC_FILES += core/t30/t30rm_clocks.c
LOCAL_SRC_FILES += core/t30/t30rm_clocks_info.c
LOCAL_SRC_FILES += core/common/nvrm_null_stub.c
LOCAL_SRC_FILES += core/ap15/ap15rm_interrupt_generic.c
LOCAL_SRC_FILES += core/t30/t30rm_pinmux.c
LOCAL_SRC_FILES += core/t30/t30rm_pinmux_tables.c
LOCAL_SRC_FILES += core/t30/t30rm_memctrl.c
LOCAL_SRC_FILES += core/t30/t30rm_smmu.c
LOCAL_SRC_FILES += core/t30/t30rm_smmu_clients.c
LOCAL_SRC_FILES += core/t30/t30rm_fuse.c
