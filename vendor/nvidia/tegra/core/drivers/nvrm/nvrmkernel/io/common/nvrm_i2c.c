...
static NvError PrivI2cSetSpeed(NvRmI2cController *c)
{
    ...
    // The clock source frequency of i2c should be 8 times on interface clcok
    // i.e. SCLK frequency.
    NvU32 PrefClockFreq = c->clockfreq * 8;

    return NvRmPowerModuleClockConfig(c->hRmDevice, ModuleId,
                        c->I2cPowerClientId, NvRmFreqUnspecified,
                        PrefClockFreq, &PrefClockFreq, 1, NULL, 0);
}
    ...
    NvU32 NumOfTransactions)
{
...
#ifndef SET_KERNEL_PINMUX
    NV_ASSERT(((hRmI2cCont->PinMapConfig == NvOdmI2cPinMap_Multiplexed) && (I2cPinMap)) ||
              ((hRmI2cCont->PinMapConfig != NvOdmI2cPinMap_Multiplexed) && (!I2cPinMap)));
#endif
    ...
    if (I2cPinMap)
    {
        NvRmPinMuxConfigSelect(hRmI2cCont->hRmDevice, hRmI2cCont->OdmIoModule,
                                        hRmI2cCont->Instance, I2cPinMap);

        NvRmPinMuxConfigSetTristate(hRmI2cCont->hRmDevice, hRmI2cCont->OdmIoModule,
                                        hRmI2cCont->Instance, I2cPinMap, NV_FALSE);
    }
#endif
...
power_config_fail:
    ...
    {
        NvRmPinMuxConfigSetTristate(hRmI2cCont->hRmDevice, hRmI2cCont->OdmIoModule,
            hRmI2cCont->Instance, I2cPinMap, NV_TRUE);

        NvRmPinMuxConfigSelect(hRmI2cCont->hRmDevice, hRmI2cCont->OdmIoModule,
            hRmI2cCont->Instance, hRmI2cCont->PinMapConfig);
    }
#endif
    ...
    NvU8 DummyCharTx)
{
    ...
    if (I2cPinMap)
    {
        ...
        NvRmPinMuxConfigSetTristate(hRmI2cCont->hRmDevice, hRmI2cCont->OdmIoModule,
            hRmI2cCont->Instance, I2cPinMap, NV_FALSE);
        hRmI2cCont->CurrPinMap = I2cPinMap;
    }
#endif
...
#ifndef SET_KERNEL_PINMUX
    //  Re-tristate multi-plexed controllers, and re-multiplex the controller.
    if (hRmI2cCont->CurrPinMap)
    {
        NvRmPinMuxConfigSetTristate(hRmI2cCont->hRmDevice, hRmI2cCont->OdmIoModule,
            hRmI2cCont->Instance, hRmI2cCont->CurrPinMap, NV_TRUE);
