...
} MSIHandlers[MAX_MSI_HANDLERS];

static struct {
    NvOsSemaphoreHandle sem;
} LegacyHandlers[MAX_LEGACY_HANDLERS];
...
NvError NvRmPrivPcieOpen(NvRmDeviceHandle hRm)
{
    ...
    {
        // Using null caps as this call is to find the presence of the module.
        {1, 0, 0, NvRmModulePlatform_Silicon, NULL},
    };
    ...
    err = NvRmMemAllocTagged(s_pcieMsiMemoryHandle, NULL, 0, MSI_MEMORY_ALIGNMENT,
            NvOsMemAttribute_Uncached,
