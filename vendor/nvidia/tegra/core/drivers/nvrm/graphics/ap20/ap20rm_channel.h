...
#define NVRM_SYNCPOINT_CSI_VI_0         (11)
#define NVRM_SYNCPOINT_CSI_VI_1         (12)
#define NVRM_SYNCPOINT_VI_ISP_0         (13)
#define NVRM_SYNCPOINT_VI_ISP_1         (14)
#define NVRM_SYNCPOINT_VI_ISP_2         (15)
#define NVRM_SYNCPOINT_VI_ISP_3         (16)
#define NVRM_SYNCPOINT_VI_ISP_4         (17)
#define NVRM_SYNCPOINT_2D_CHANNEL1_0    (18)
#define NVRM_SYNCPOINT_2D_CHANNEL1_1    (19)
#define NVRM_SYNCPOINT_2D_CHANNEL2_0    (20)
#define NVRM_SYNCPOINT_2D_CHANNEL2_1    (21)
#define NVRM_SYNCPOINT_3D               (22)
#define NVRM_SYNCPOINT_3D_HIPRIO        (5)
#define NVRM_SYNCPOINT_MPE              (23)
...
#define NVRM_SYNCPOINT_MPE_EBM_EOF      (28)
#define NVRM_SYNCPOINT_MPE_WR_SAFE      (29)
#define NVRM_SYNCPOINT_2D_TINYBLT_WAR   (30)
#define NVRM_SYNCPOINT_2D_TINYBLT_RESTORE_CLASS_ID   (30)
#define NVRM_SYNCPOINT_DSI              (31)

#define NVRM_SYNCPOINTS_RESERVED \
    ((1UL << NVRM_SYNCPOINT_CSI_VI_0)    | \
     (1UL << NVRM_SYNCPOINT_CSI_VI_1)    | \
     (1UL << NVRM_SYNCPOINT_VI_ISP_0)    | \
     (1UL << NVRM_SYNCPOINT_VI_ISP_1)    | \
     (1UL << NVRM_SYNCPOINT_VI_ISP_2)    | \
     (1UL << NVRM_SYNCPOINT_VI_ISP_3)    | \
     (1UL << NVRM_SYNCPOINT_VI_ISP_4)    | \
     (1UL << NVRM_SYNCPOINT_2D_CHANNEL1_0) | \
     (1UL << NVRM_SYNCPOINT_2D_CHANNEL1_1) | \
     (1UL << NVRM_SYNCPOINT_2D_CHANNEL2_0) | \
     (1UL << NVRM_SYNCPOINT_2D_CHANNEL2_1) | \
     (1UL << NVRM_SYNCPOINT_3D)          | \
     (1UL << NVRM_SYNCPOINT_MPE)         | \
     (1UL << NVRM_SYNCPOINT_DISP0)       | \
     (1UL << NVRM_SYNCPOINT_DISP1)       | \
     (1UL << NVRM_SYNCPOINT_MPE_EBM_EOF) | \
     (1UL << NVRM_SYNCPOINT_MPE_WR_SAFE) | \
     (1UL << NVRM_SYNCPOINT_VBLANK0)     | \
     (1UL << NVRM_SYNCPOINT_VBLANK1)     | \
     (1UL << NVRM_SYNCPOINT_2D_TINYBLT_WAR) | \
...
#define NVRM_MODULEMUTEX_2D_FULL        (1)
#define NVRM_MODULEMUTEX_2D_SIMPLE      (2)
#define NVRM_MODULEMUTEX_2D_SB_A        (3)
#define NVRM_MODULEMUTEX_2D_SB_B        (4)
#define NVRM_MODULEMUTEX_3D             (5)
#define NVRM_MODULEMUTEX_DISPLAYA       (6)
#define NVRM_MODULEMUTEX_DISPLAYB       (7)
#define NVRM_MODULEMUTEX_VI             (8)
#define NVRM_MODULEMUTEX_DSI            (9)

#define NVRM_WAITBASE_2D_0              (1)
#define NVRM_WAITBASE_2D_1              (2)
#define NVRM_WAITBASE_3D                (3)
#define NVRM_WAITBASE_MPE               (4)

#define NVRM_WAITBASE_RESERVED \
    ((1UL << NVRM_WAITBASE_2D_0) | \
     (1UL << NVRM_WAITBASE_2D_1) | \
     (1UL << NVRM_WAITBASE_3D)   | \
     (1UL << NVRM_WAITBASE_MPE))
...
#define NVRM_AUTO_CLOCK_MODULES         4
#define NVRM_AUTO_CLOCK_MODULE_2D       (0)
#define NVRM_AUTO_CLOCK_MODULE_3D       (1)
#define NVRM_AUTO_CLOCK_MODULE_MPE      (2)
#define NVRM_AUTO_CLOCK_MODULE_DISPLAY  (3)
