 ...
 * this function becomes a NOP in this case.
 *
 * @param FuseData buffer containing fuse data
 * @param MaskData buffer containing masks to use prior to writing
 * @param NumWords count of the number of words of fuse data
 * @param TProgramCycles number of clock cycles spent on each fuse
 *        (0 means no change)
 */
void
NvBootFuseProgramFuseArray(NvU32 *FuseData,
                           NvU32 *MaskData,
                           NvU32  NumWords,
 ...
 *
 * @param FuseData buffer containing fuse data
 * @param MaskData buffer containing masks to use in the comparisons
 * @param NumWords count of the number of words of fuse data
 *
 ...
 */
NvBootError
NvBootFuseVerifyFuseArray(NvU32 *FuseData,
                          NvU32 *MaskData,
                          NvU32  NumWords);
