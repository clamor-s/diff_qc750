...
/*
 * nvboot_hacks.h - Definition of constants that disble or hardcode values
...
#ifndef INCLUDED_NVBOOT_HACKS_H
#define INCLUDED_NVBOOT_HACKS_H
...
#define NVBOOT_DEFAULT_UID0 0
#define NVBOOT_DEFAULT_UID1 0

#if defined(__cplusplus)
}
#endif

#endif /* #ifndef INCLUDED_NVBOOT_HACKS_H */
