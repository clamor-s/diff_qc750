...
// Bit 6 == 1: the clock is associated with a bit in register CLK_ENB,
// offset encoded in bits 5:0
//             bit 5 == 1 for the _H register and 0 for the _L register
//             bit 4:0 is the offset in the register, that is the _SHIFT part
// Bit 6 == 0: the clock has no associated bit in register CLK_ENB,
// bits 5:0 form a secondary ID
//             it also happens that none of these clocks has a source
// register in standard format
// The two MSB encode the offset of the source register if of standard format,
//  0 if not
...
#define NVBOOT_CLOCKS_HAS_STANDARD_ENB(ClockId) \
    (((NvU32) ClockId) & NVBOOT_CLOCKS_STANDARD_ENB)

#define NVBOOT_CLOCKS_BIT_OFFSET(ClockId) \
    (((NvU32) ClockId) & NVBOOT_CLOCKS_ENB_BIT_OFFSET_MASK)

#define NVBOOT_CLOCKS_REG_OFFSET(ClockId) \
    ( (((NvU32) ClockId) & NVBOOT_CLOCKS_H_REG) >> 3 )

#define NVBOOT_CLOCKS_SOURCE_OFFSET(ClockId) \
    ( (((NvU32) ClockId) & ~((1<<NVBOOT_CLOCKS_SOURCE_SHIFT) -1))\
...
{  
    ...
    NvBootClocksClockId_VclkId,
    NvBootClocksClockId_ClkdId,

    NvBootClocksClockId_CclkId   = 
        CLK_RST_CONTROLLER_CLK_OUT_ENB_L_0_CLK_ENB_CPU_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB,

    NvBootClocksClockId_UsbId    = 
        CLK_RST_CONTROLLER_CLK_OUT_ENB_L_0_CLK_ENB_USBD_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB,

    NvBootClocksClockId_I2c1Id   =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_L_0_CLK_ENB_I2C1_SHIFT +  
        NVBOOT_CLOCKS_STANDARD_ENB +
        (CLK_RST_CONTROLLER_CLK_SOURCE_I2C1_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),

    NvBootClocksClockId_NandId   =
    ...
    NvBootClocksClockId_HsmmcId  =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_L_0_CLK_ENB_HSMMC_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB +
        (CLK_RST_CONTROLLER_CLK_SOURCE_HSMMC_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),

    NvBootClocksClockId_BseaId   =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_BSEA_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,
 
    NvBootClocksClockId_BsevId   =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_BSEV_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,

    NvBootClocksClockId_KbcId    =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_KBC_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,

    NvBootClocksClockId_VdeId    =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_VDE_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,

    NvBootClocksClockId_ApbDmaId =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_APBDMA_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,

    NvBootClocksClockId_AhbDmaId =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_AHBDMA_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG, 

    NvBootClocksClockId_NorId    =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_NOR_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,

    NvBootClocksClockId_McId     =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_MEM_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,

    NvBootClocksClockId_EmcId    =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_EMC_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG,

    NvBootClocksClockId_SpiId    =
        CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_SPI1_SHIFT +
        NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG +
...
#define NVBOOT_CLOCKS_CHECK_CLOCKID(ClockId) \
    NV_ASSERT( (ClockId == NvBootClocksClockId_SclkId)   || \
               ...
               (ClockId == NvBootClocksClockId_VclkId)   || \
               (ClockId == NvBootClocksClockId_ClkdId)   || \
               ...
               (ClockId == NvBootClocksClockId_HsmmcId)  || \
               ...
               (ClockId == NvBootClocksClockId_NorId)    || \
...
#define NVBOOT_CLOCKS_SYS_STATE_RUN (0x2)
#define NVBOOT_CLOCKS_CPU_STATE_RUN (0x2)
...
typedef enum
{  
    NvBootClocksPllId_PllC = (CLK_RST_CONTROLLER_PLLC_BASE_0 << 16) |
        CLK_RST_CONTROLLER_PLLC_MISC_0,

    NvBootClocksPllId_PllM = (CLK_RST_CONTROLLER_PLLM_BASE_0 << 16) |
        CLK_RST_CONTROLLER_PLLM_MISC_0,

    NvBootClocksPllId_PllU = (CLK_RST_CONTROLLER_PLLU_BASE_0 << 16) |
        CLK_RST_CONTROLLER_PLLU_MISC_0,

    NvBootClocksPllId_PllP = (CLK_RST_CONTROLLER_PLLP_BASE_0 << 16) |
...
/* 
 * NvBootClocksStartPll(): Start the identified PLL, track its stabilization
 * time 
 */
void
...
/* defines for common source selection */
/* we only support PLLP_OUT0 for all these */
#define NVBOOT_CLOCKS_DEVICE_CLOCK_SOURCE_PLLP_OUT0 (0) 

/* we support PLLP_OUT0 and PLLM_OUT0 for EMC */
#define NVBOOT_CLOCKS_EMC_CLOCk_SOURCE_PLLM_OUT0 (0)
#define NVBOOT_CLOCKS_EMC_CLOCk_SOURCE_PLLP_OUT0 (2)
#define NVBOOT_CLOCKS_EMC_CLOCK_SOURCE_CLK_M     (3)
/* we support PLLP_OUT0, PLLC_OUT0, CLKM and PLLM_OUT0 for MC */
#define NVBOOT_CLOCKS_MC_CLOCk_SOURCE_PLLC_OUT0 (1)
#define NVBOOT_CLOCKS_MC_CLOCk_SOURCE_PLLP_OUT0 (4)
#define NVBOOT_CLOCKS_MC_CLOCk_SOURCE_PLLM_OUT0 (3)
#define NVBOOT_CLOCKS_MC_CLOCk_SOURCE_CLK_M     (0)
/* we support PLLP_OUT4 and PLLC_OUT1 for system clock + clk_m  and clk_d */
#define NVBOOT_CLOCKS_SCLK_CLOCK_SOURCE_PLLC_OUT1 (1)
#define NVBOOT_CLOCKS_SCLK_CLOCK_SOURCE_PLLP_OUT4 (2)
#define NVBOOT_CLOCKS_SCLK_CLOCK_SOURCE_CLKM (0)
#define NVBOOT_CLOCKS_SCLK_CLOCK_SOURCE_CLKD (5)
/*
 * we support PLLP_OUT0, PLLP_OUT4 and PLLC_OUT0 for CPU clock + clk_m 
 * and clk_d
 */
#define NVBOOT_CLOCKS_CCLK_CLOCK_SOURCE_PLLC_OUT0 (1)
#define NVBOOT_CLOCKS_CCLK_CLOCK_SOURCE_PLLP_OUT0 (4)
#define NVBOOT_CLOCKS_CCLK_CLOCK_SOURCE_PLLP_OUT4 (5)
#define NVBOOT_CLOCKS_CCLK_CLOCK_SOURCE_CLKM (0)
#define NVBOOT_CLOCKS_CCLK_CLOCK_SOURCE_CLKD (7)
/*
 * some system clocks have fixed source, but still a define for 
 * documentation
 */
#define NVBOOT_CLOCKS_HCLK_CLOCKS_SOURCE_SCLK (0)
#define NVBOOT_CLOCKS_PCLK_CLOCKS_SOURCE_HCLK (0)
#define NVBOOT_CLOCKS_VCLK_CLOCKS_SOURCE_SCLK (0)
#define NVBOOT_CLOCKS_CLKD_ClOCKS_SOURCE_CLKM (0)
#define NVBOOT_CLOCKS_COPCLK_CLOCKS_SOURCE_SCLK (0)

/*
 * For 7.1 the ratio can be an integer multiple of 0.5 larger than 1
 * the divider value to program equal the desired ratio * 2 - 2 or
 * alternately 2 * (desired ratio - 1)
 * to avoid floating point, this is done as 2 * integer part of ratio + 1
 * if odd multiple of 0.5 - 2
 */
#define NVBOOT_CLOCKS_7_1_DIVIDER_BY(INT_RATIO, PLUS_HALF) \
...
/* for devices, reference is PLLP, so express that in absolute frequency */
...
#define NVBOOT_CLOCKS_PLLP_OUT0_DIV_TO_6_4_MHZ   \
     NVBOOT_CLOCKS_7_1_DIVIDER_BY_67_5
...
/* 
 * NvBootClocksStartPllpBeforeScatterLoad(): Special function that runs before
 * scatter loading
