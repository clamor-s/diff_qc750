 ...
 * @return None
 */
void NvBootAesClearIv(NvBootAesEngine engine);
 ...
 * @return None
 */
void NvBootAesSetIv(NvBootAesEngine engine, NvBootAesIv *pIv);
 ...
 * @return None
 */
void NvBootAesGetIv(NvBootAesEngine engine, NvBootAesIv *pIv);
