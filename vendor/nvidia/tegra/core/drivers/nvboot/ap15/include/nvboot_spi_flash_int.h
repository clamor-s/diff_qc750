...
/**
  * nvboot_spi_flash.h - Public definitions for using SPI_FLASH as the
...
#include "ap15/nvboot_spi_flash_param.h"
#include "nvboot_spi_flash_context_int.h"
...
/**
  * NvBootSpiFlashValidateParams(): Checks the contents of the parameter structure
...
/**
  * NvBootSpiFlashInit(): Use the data pointed to by DevParams to initialize the
  ...
  *
  * @param  Params Input Parameters
  * @param  Context  A pointer to the Context used by the driver for later purpose
  *
...
/**
  ...
  *
  * @retval  NvBootError_Success   No Error
  * @retval  NvBootError_HwTimeOut When H/w doesn't respond or wasn't able to write
  *
  */
NvBootError
...
/**
  ...
  * @retval   NvBootDeviceStatus_ReadFailure when the previous transfer couldn't complete in time.
  * @retval  NvBootDeviceStatus_ReadInProgress when the previous transfer is in progress
  *
  *
  */
NvBootDeviceStatus
