...
{                                                                     \
        .RegOffset = PINMUX_AUX_##_Pingroup##_0,                      \
        .IO_Reset  = PINMUX_AUX_##_Pingroup##_0_IO_RESET_##_IO_Reset, \
        .Lock      = PINMUX_AUX_##_Pingroup##_0_LOCK_DEFAULT,         \
        .E_Od      = NV_PINMUX_E_OD_DEFAULT,                          \
        .E_Input   = PINMUX_AUX_##_Pingroup##_0_E_INPUT_##_E_Input,   \
        .Tristate  = PINMUX_AUX_##_Pingroup##_0_TRISTATE_##_Tristate, \
        .Pupd      = PINMUX_AUX_##_Pingroup##_0_PUPD_##_Pupd,         \
        .Pinmux    = PINMUX_AUX_##_Pingroup##_0_PM_##_Pinmux          \
}

#define DEFAULT_PINMUX(_Pingroup, _Pinmux, _Pupd, _Tristate, _E_Input) \
{                                                                      \
        .RegOffset = PINMUX_AUX_##_Pingroup##_0,                       \
        .IO_Reset  = NV_PINMUX_IO_RESET_VALUE_DEFAULT,                 \
        .Lock      = PINMUX_AUX_##_Pingroup##_0_LOCK_DEFAULT,          \
        .E_Od      = NV_PINMUX_E_OD_DEFAULT,                           \
        .E_Input   = PINMUX_AUX_##_Pingroup##_0_E_INPUT_##_E_Input,    \
        .Tristate  = PINMUX_AUX_##_Pingroup##_0_TRISTATE_##_Tristate,  \
...
{                                                                      \
        .RegOffset = PINMUX_AUX_##_Pingroup##_0,                       \
        .IO_Reset  = NV_PINMUX_IO_RESET_VALUE_DEFAULT,                 \
        .Lock      = PINMUX_AUX_##_Pingroup##_0_LOCK_##_Lock,          \
        .E_Od      = PINMUX_AUX_##_Pingroup##_0_OD_##_E_Od,            \
        .E_Input   = PINMUX_AUX_##_Pingroup##_0_E_INPUT_##_E_Input,    \
        .Tristate  = PINMUX_AUX_##_Pingroup##_0_TRISTATE_##_Tristate,  \
        .Pupd      = PINMUX_AUX_##_Pingroup##_0_PUPD_##_Pupd,          \
        .Pinmux    = PINMUX_AUX_##_Pingroup##_0_PM_##_Pinmux           \
