...
static SensorSetModeSequence g_SensorBayerSetModeSequenceListCSISingle[] =
{
    ...
    {{{1920, 1080}, {0, 2}, 30, 1.0, 18, NvOdmImagerNoCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal}, NULL, &ModeDependentSettings_OV2710_1920X1080},

    // temporary disable 1280x720 mode until we resolved the field of view and lens shading issues.
    //{{{1280, 720}, {0, 2}, 30, 1.0, 20, NvOdmImagerPartialCropMode}, NULL, &ModeDependentSettings_OV2710_1280X720},
};
    ...
    NvOdmImagerPowerLevel PowerLevel)
{
    ...
    switch(PowerLevel)
    {
        case NvOdmImagerPowerLevel_On:
            pContext->camera_fd = open("/dev/ov2710", O_RDWR);
