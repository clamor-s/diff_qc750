...
{
    [OV9726_SENSOR_MODE_1280X720] = {{{1280, 720}, {0, 0}, 30, 1.0, 0,
        NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal}, NULL, &ModeDependentSettings_ov9726_1280X720},
    [OV9726_SENSOR_MODE_1280X800] = {{{1280, 800}, {0, 0}, 30, 1.0, 0,
        NvOdmImagerNoCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal}, NULL, &ModeDependentSettings_ov9726_1280X800},
};
    ...
    const NvOdmImagerClockProfile *pClockProfile)
{
    ...
    if (pContext->SensorInitialized)
    {
        ...
        NVDEBUG_LOG("SensorBayer_SetInputClock : %f (%f, %f), Freq=%d\r\n",
                  pContext->Exposure,
                  pContext->MinExposure,
                  pContext->MaxExposure,
                  pContext->VtPixClkFreqHz);
        ...
        NvOsDebugPrintf("SensorBayer_SetInputClock : warning - senosr not initialized yet!\r\n");
    }
    return NV_TRUE;
}
    ...
    const void *pValue)
{
    ...
    switch (Param)
    {
        ...
        case NvOdmImagerParameter_SensorInputClock:
            NVDEBUG_LOG("SensorBayer_SetParameter: NvOdmImagerParameter_SensorInputClock\r\n");
