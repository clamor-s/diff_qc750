...
struct TimedEventQueue {
    ...
    protected:
        ...
        virtual void fire(TimedEventQueue *queue, int64_t now_us, int arg1, int arg2, int arg3) {};
        bool mUsesArgs;
    ...
    event_id postEvent(const sp<Event> &event, int arg1 = 0, int arg2 = 0, int arg3 = 0);
    ...
    event_id postTimedEvent(const sp<Event> &event, int64_t realtime_us, int arg1 = 0, int arg2 = 0, int arg3 = 0);
...
private:
    ...
    sp<Event> removeEventFromQueue_l(event_id id, int &arg1, int &arg2, int &arg3);
