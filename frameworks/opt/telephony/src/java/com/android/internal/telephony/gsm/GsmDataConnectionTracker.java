...
public final class GsmDataConnectionTracker extends DataConnectionTracker {
    ...
    protected void initApnContextsAndDataConnection() {
        ...
        int networkAttr;
        if(SystemProperties.getInt("ro.boot.module_3g_config", 0)==0){
            networkAttr =com.android.internal.R.array.networkAttributes;
        }
        else{
            networkAttr =com.android.internal.R.array.networkAttributes_3G;
        }

        String[] networkConfigStrings = mPhone.getContext().getResources().getStringArray(networkAttr);
