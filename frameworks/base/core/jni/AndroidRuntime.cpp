...
extern int register_com_nvidia_NvCpuClient(JNIEnv *env);
extern int register_nvidia_hardware_NvCamera(JNIEnv *env);
...
static const RegJNIRec gRegJNI[] = {
    ...
    REG_JNI(register_com_nvidia_NvCpuClient),
    REG_JNI(register_nvidia_hardware_NvCamera),
