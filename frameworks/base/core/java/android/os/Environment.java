...
public class Environment {
    ...
    private static final String ENV_APP2SD_STORAGE = "APP2SD_STORAGE";
     ...
     * @hide
     */
    public static boolean isApp2SdEnabled(){
        return SystemProperties.getBoolean("sys.en.app2sd2", false);
    }
    
    /**
     * @hide
     */
    public static boolean isApp2SdEnabledInSetting(){
        return SystemProperties.getBoolean("persist.sys.en.app2sd2", false);
    }
    
    /**
     * @hide
     */
    public static int getApp2SdTimeOut(){
        return SystemProperties.getInt("persist.sys.timeout.app2sd2", -1);
    }
    
    /**
     * @hide
     */
    public static boolean isApp2SdSupportMvCache(){
        return SystemProperties.getBoolean("sys.en.app2sd2_mv_cache", false);
    }
     ...
     *@hide 
     */
    public static File getExternalStorageDirectoryNotCheckIfSystem() {
        return sCurrentUser.getExternalStorageDirectory();
    }
     ...
     *@hide
     */
    public static File getApp2SdStorageDirectory(){
        String path =System.getenv(ENV_APP2SD_STORAGE);
     ...
     *@hide
     */
    public static String getApp2SdStorageState(){
        String path =System.getenv(ENV_APP2SD_STORAGE);
        try {
            IMountService mountService = IMountService.Stub.asInterface(ServiceManager
                    .getService("mount"));
