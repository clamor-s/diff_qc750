...
class HTML5VideoViewProxy extends Handler
    ...
    private static final class VideoPlayer {
        ...
        private static void setPlayerBuffering(boolean playerBuffering) {
            ...
            // set appropriate playing state in VideoLayer to show buffering animation or video
            if (mCurrentProxy.mBaseLayer != 0)
                setBaseLayer(mCurrentProxy.mBaseLayer);
        }
        ...
        public static void pauseAndDispatch() {
            if (mHTML5VideoView != null) {
                mHTML5VideoView.pauseAndDispatch(mCurrentProxy);
                // Release the media player in order to relinquish resources like
                // streaming server, wifi connection, etc. This will help system to go
                // into LP0 mode when display is turned off.
                mHTML5VideoView.suspendMediaPlayer();
            }
        }
        ...
        public static void enterFullScreenVideo(int layerId, String url,
                ...
                if (mHTML5VideoView != null) {
                    ...
                    // Time update timer is not required in fullscreen. This will avoid layout and save power.
                    mHTML5VideoView.stopTimeUpdateTimer();
                }
        ...
        public static void play(String url, int time, HTML5VideoViewProxy proxy,
            ...
            if (backFromFullScreenMode
                ...
                if (mHTML5VideoView != null && !mHTML5VideoView.isReleased() ) {
                    if (!backFromFullScreenMode) {
                        mHTML5VideoView.pauseAndDispatch(mCurrentProxy);
                    }
                    mHTML5VideoView.reset();
    ...
    public void onBufferingupdate() {
        // Send inval view to keep buffering animation running
