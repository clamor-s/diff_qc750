...
public class WebSettingsClassic extends WebSettings {
    ...
    private boolean         mAccelerated2DCanvasEnabled = true;
     ...
     * @hide
     */
    public synchronized void setWebGLEnabled(boolean enabled) {
        if (mWebGLEnabled != enabled) {
            mWebGLEnabled = enabled;
            postSync();
        }
    }
    ...
    public synchronized boolean getWebGLEnabled() {
        return mWebGLEnabled;
    }

    /**
     * @hide
     */
    public synchronized void setAccelerated2DCanvasEnabled(boolean enabled) {
        if (mAccelerated2DCanvasEnabled != enabled) {
            mAccelerated2DCanvasEnabled = enabled;
            postSync();
        }
    }
    ...
    public synchronized boolean getAccelerated2DCanvasEnabled() {
        return mAccelerated2DCanvasEnabled;
    }
