...
public class TitleBar extends RelativeLayout {
    ...
    private void setFixedTitleBar() {
        ...
        mBaseUi.setTitleBar(this, mIsFixedTitleBar);
        updateContentViewMarginTop();
    }

    public void setForceFixedTitleBar(boolean fixed) {
        mForceFixed = fixed;
        setFixedTitleBar();
    }

    void updateContentViewMarginTop() {
        if (mIsFixedTitleBar) {
