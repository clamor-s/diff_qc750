...
public class CameraSettings {
    ...
    public static final String KEY_VIDEO_STABILIZATION = "pref_camera_videostabilization_key";
    ...
    private void initPreference(PreferenceGroup group) {
        ...
        ListPreference videoStabilization = group.findPreference(KEY_VIDEO_STABILIZATION);
        ...
        if ((vstabSupported == null) || vstabSupported.equals("false")) {
            Log.e(TAG, "Video Stabilization not supported,");
            removePreference(group, KEY_VIDEO_STABILIZATION);
        }
    }
