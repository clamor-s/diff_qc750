...
public class CameraManager {
    ...
    private NvCpuClientWrapper mNvCpuClientStillPreview = null;
    ...
    private CameraManager() {
        ...
        try {
            ...
            mNvCpuClientStillPreview = new NvCpuClientWrapper();
        } catch (ClassNotFoundException e) {
            mNvCpuClientStillPreview = null;
    ...
    public void mNvSetPreviewCaps() {
        Log.v(TAG,"Setting Preview Caps\n");
        if(mNvCpuClientStillPreview != null)
            mNvCpuClientStillPreview.NvSetCpuMaxFreq(
                NvCpuClientWrapper.NVCPU_BOOST_STRENGTH_MEDIUM);
    }

    public void mNvClearPreviewCaps() {
        Log.v(TAG,"Clearing Preview Caps\n");
        if(mNvCpuClientStillPreview != null)
            mNvCpuClientStillPreview.NvClearCpuMaxFreq();
    }
