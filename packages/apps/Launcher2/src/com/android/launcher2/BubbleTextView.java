    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                // HACK
                // Just set pressed immediately on action down
                // This noticeably shortens response time
                // But may cause icons to light up then fade if a swipe starts on an icon
                setPressed(true);
