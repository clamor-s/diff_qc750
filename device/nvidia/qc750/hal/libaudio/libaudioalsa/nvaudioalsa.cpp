...
#define TEGRA3_DEFAULT_OUT_SAMPLE_RATE   44100
...
static status_t NvAudioALSADevRoute(NvAudioALSADev *hDev, uint32_t devices, int mode)
{
    ...
    if (alsaCtrl) {
		...
		if (devices & (AudioSystem::DEVICE_OUT_EARPIECE |
			...
			alsaCtrl->set("LOL Output Mixer L_DAC switch", (uint32_t)1);
		    alsaCtrl->set("LOR Output Mixer R_DAC switch", (uint32_t)1);
			//alsaCtrl->set("Left LO driver mute", (uint32_t)0);
			//alsaCtrl->set("Right LO driver mute", (uint32_t)0);
			//alsaCtrl->set("DAC Digital Volume Control", (uint32_t)127);
			//alsaCtrl->set("Line Driver Gain", (uint32_t)6);
			...
			alsaCtrl->set("LOL Output Mixer L_DAC switch", (uint32_t)0);
		    alsaCtrl->set("LOR Output Mixer R_DAC switch", (uint32_t)0);
			//alsaCtrl->set("Left LO driver mute", (uint32_t)0);
			//alsaCtrl->set("Right LO driver mute", (uint32_t)0);
			//alsaCtrl->set("DAC Digital Volume Control", (uint32_t)127);
			//alsaCtrl->set("Line Driver Gain", (uint32_t)6);
		 ...
		 if (devices & (AudioSystem::DEVICE_OUT_WIRED_HEADSET |
                               AudioSystem::DEVICE_OUT_WIRED_HEADPHONE)) {
                    // FIXME for Kai
			alsaCtrl->set("HPL Output Mixer L_DAC switch", (uint32_t)1);
			alsaCtrl->set("HPR Output Mixer R_DAC switch", (uint32_t)1);
			//alsaCtrl->set("Left HP driver mute", (uint32_t)0);
			//alsaCtrl->set("Right HP driver mute", (uint32_t)0);
			//alsaCtrl->set("DAC Digital Volume Control", (uint32_t)60);
			//alsaCtrl->set("HP Driver Gain", (uint32_t)6);
			alsaCtrl->set("Headphone Jack Switch", (uint32_t)1);
                }
                else if (hDev->curDev & (AudioSystem::DEVICE_OUT_WIRED_HEADSET |
                               AudioSystem::DEVICE_OUT_WIRED_HEADPHONE)){
                    // FIXME for Kai
			alsaCtrl->set("HPL Output Mixer L_DAC switch", (uint32_t)0);
			alsaCtrl->set("HPR Output Mixer R_DAC switch", (uint32_t)0);
			//alsaCtrl->set("Left HP driver mute", (uint32_t)0);
			//alsaCtrl->set("Right HP driver mute", (uint32_t)0);
			//alsaCtrl->set("DAC Digital Volume Control", (uint32_t)127);
			//alsaCtrl->set("HP Driver Gain", (uint32_t)6);
			alsaCtrl->set("Headphone Jack Switch", (uint32_t)0);
                ...
                if ((devices & (AudioSystem::DEVICE_IN_BUILTIN_MIC |
                            ...
                            AudioSystem::DEVICE_IN_BACK_MIC|
							AudioSystem::DEVICE_IN_WIRED_HEADSET))) {
					//alsaCtrl->set("Left Input Mixer IN3_L switch", (uint32_t)1);
					//alsaCtrl->set("Left Input Mixer IN3_R switch", (uint32_t)1);
					//alsaCtrl->set("Left Input Mixer IN1_L switch", (uint32_t)1);
					//alsaCtrl->set("Left Input Mixer IN1_R switch", (uint32_t)1);
					alsaCtrl->set("Mic_Bias_Power_ctrl", (uint32_t)1);
                    alsaCtrl->set("Int Mic Switch", (uint32_t)1);
					//alsaCtrl->set("Ext Mic Switch", (uint32_t)1);
					...
					alsaCtrl->set("Mic_Bias_Power_ctrl", (uint32_t)0);
					//alsaCtrl->set("Left Input Mixer IN3_L switch", (uint32_t)0);
					//alsaCtrl->set("Left Input Mixer IN3_R switch", (uint32_t)0);
					//alsaCtrl->set("Left Input Mixer IN1_L switch", (uint32_t)0);
					//alsaCtrl->set("Left Input Mixer IN1_R switch", (uint32_t)0);
					//alsaCtrl->set("Ext Mic Switch", (uint32_t)0);
				}
