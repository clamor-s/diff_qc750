...
TARGET_USE_DTB := true
ifeq ($(TARGET_PRODUCT),tai)
TARGET_KERNEL_DT_NAME := tegra30-tai
else
TARGET_KERNEL_DT_NAME := tegra30-enterprise
endif
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR ?= device/nvidia/enterprise/bluetooth
...
# This should be enabled if you wish to use information from liboverlay to enable
